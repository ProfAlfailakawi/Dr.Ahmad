...
const GLOSSARY: XrayTerm[] = [
  ...
  // ── تقنيات التعليم ──
  { term: 'التعلّم الإلكتروني', title: 'التعلّم الإلكتروني', definition: 'التعلّم الذي توسّطه التقنيات الرقمية والشبكات، حضوريًا أو عن بُعد، بما يتيح مرونة في الزمان والمكان والمصادر.' },
  { term: 'التعليم الإلكتروني', title: 'التعليم الإلكتروني', definition: 'توظيف الوسائط والمنصات الرقمية في تنظيم التعليم وإدارته وتقديمه، مع الحفاظ على جوهر العلاقة التربوية.' },
  { term: 'التعلّم عن بُعد', title: 'التعلّم عن بُعد', definition: 'نمط يفصل بين المعلّم والمتعلّم مكانيًا أو زمنيًا، ويعوّض ذلك بوسائط وتفاعل مصمّم بعناية.', note: 'الجودة لا تأتي من البُعد نفسه، بل من تصميم التفاعل والدعم.' },
  { term: 'الفصل المقلوب', title: 'الفصل المقلوب', definition: 'نموذج يتعرّف فيه الطالب على المحتوى قبل الحصة، ليُخصَّص وقت الصف للنقاش والتطبيق وحلّ المشكلات.' },
  { term: 'التلعيب', title: 'التلعيب', definition: 'توظيف عناصر اللعب — كالتحدّي والنقاط والمستويات — في سياقات غير لعبية لرفع الدافعية والمشاركة.', note: 'المقصد أثرٌ في التعلّم لا مجرد تسلية أو مكافآت سطحية.' },
  { term: 'الواقع المعزّز', title: 'الواقع المعزّز', definition: 'دمج عناصر رقمية فوق العالم الحقيقي عبر الشاشة، فتُضاف طبقة معلومات على ما يراه المستخدم.' },
  { term: 'أنظمة إدارة التعلّم', title: 'أنظمة إدارة التعلّم', definition: 'منصات تنظّم المقررات والمحتوى والأنشطة والتقويم والتواصل في مكان واحد، مثل مودل وبلاكبورد.' },
  { term: 'مودل', title: 'مودل (Moodle)', definition: 'منصّة مفتوحة المصدر لإدارة التعلّم، تتيح بناء المقررات والأنشطة والتقويم وإدارة تفاعل الطلبة.' },
  { term: 'الحوسبة السحابية', title: 'الحوسبة السحابية', definition: 'إتاحة موارد الحوسبة والتخزين والخدمات عبر الإنترنت عند الطلب، بدل الاعتماد على أجهزة محلية وحدها.' },
  { term: 'السبورة التفاعلية', title: 'السبورة التفاعلية', definition: 'شاشة عرض تفاعلية تتيح الكتابة والتحكّم وعرض الوسائط والمشاركة الصفّية بلمسة مباشرة.' },
  { term: 'التعلّم التكيّفي', title: 'التعلّم التكيّفي', definition: 'مسارات تعليمية تتكيّف آنيًا مع مستوى المتعلّم واستجاباته، فتقدّم لكلّ طالب ما يناسبه.' },
  { term: 'التعلّم القائم على المشاريع', title: 'التعلّم القائم على المشاريع', definition: 'تعلّمٌ يتمحور حول إنجاز مشروع حقيقي يمتد عبر الزمن، فيدمج المعرفة بالمهارة والتطبيق.' },

  // ── الذكاء الاصطناعي والمجتمع الرقمي ──
  { term: 'النماذج اللغوية الكبيرة', title: 'النماذج اللغوية الكبيرة', definition: 'أنظمة تعلّم عميق دُرّبت على كميات ضخمة من النصوص لتتنبّأ بالكلمة التالية، فتولّد لغةً متماسكة.', note: 'تجيد الصياغة لا الفهم؛ التحقّق البشري يبقى شرطًا.' },
  { term: 'الخوارزمية', title: 'الخوارزمية', definition: 'سلسلة خطوات محدّدة تحوّل مدخلات إلى مخرجات لحلّ مسألة أو اتخاذ قرار.' },
  { term: 'التحيّز الخوارزمي', title: 'التحيّز الخوارزمي', definition: 'انحياز منهجي في مخرجات النظام ينشأ من بيانات أو تصميم غير متوازن، فيعيد إنتاج ظلمٍ قائم أو يضخّمه.' },
  { term: 'البيانات الضخمة', title: 'البيانات الضخمة', definition: 'بيانات هائلة الحجم والتنوّع والسرعة، تتطلّب أدوات خاصة لتخزينها وتحليلها واستخلاص المعنى منها.' },
  { term: 'المواطنة الرقمية', title: 'المواطنة الرقمية', definition: 'استخدام التقنية بوعي ومسؤولية وأمان واحترام، بما يشمل الحقوق والواجبات والسلوك الأخلاقي في الفضاء الرقمي.' },
  { term: 'الأمن السيبراني', title: 'الأمن السيبراني', definition: 'حماية الأنظمة والبيانات والأشخاص من التهديدات الرقمية، صونًا للخصوصية والثقة واستمرارية الخدمة.' },
  { term: 'الخصوصية الرقمية', title: 'الخصوصية الرقمية', definition: 'حقّ الفرد في التحكّم بمن يصل إلى بياناته وكيف تُجمع وتُستخدم، في عالمٍ يترك فيه كلّ فعلٍ أثرًا.' },
  { term: 'الفجوة الرقمية', title: 'الفجوة الرقمية', definition: 'التفاوت في الوصول إلى التقنية ومهاراتها بين الأفراد والفئات، بما يعمّق فوارق الفرص إن لم يُعالَج.' },
  { term: 'الاعتماد المفرط', title: 'الاعتماد المفرط على التقنية', definition: 'ميل المستخدم إلى قبول مخرجات الأنظمة دون تدقيق، فيتراجع دوره كخطّ دفاعٍ أخير عن القرار.' },

  // ── التربية وعلم النفس ──
  { term: 'ما وراء المعرفة', title: 'ما وراء المعرفة', definition: 'وعي المتعلّم بتفكيره وتخطيطه ومراقبته وتقويمه لتعلّمه، أي أن «يفكّر في كيف يفكّر».' },
  { term: 'البنائية', title: 'البنائية', definition: 'رؤية ترى أن المتعلّم يبني معرفته بنشاط من خلال خبرته وتفاعله، لا يتلقّاها جاهزة.' },
  { term: 'التعلّم النشط', title: 'التعلّم النشط', definition: 'إشراك المتعلّم في التفكير والتطبيق والنقاش بدل التلقّي السلبي، فيصبح صانعًا للمعنى لا مستقبِلًا له.' },
  { term: 'التقييم الختامي', title: 'التقييم الختامي', definition: 'حكمٌ على مستوى التعلّم عند نهاية وحدة أو مقرر، غالبًا بدرجة، ليقيس ما تحقّق من الأهداف.' },
  { term: 'المهارات الناعمة', title: 'المهارات الناعمة', definition: 'قدرات إنسانية عابرة للتخصّص كالتواصل والتعاون وحلّ المشكلات والتعاطف، تحدّد نجاح الإنسان لا معرفته وحدها.' },
  { term: 'التفكير التصميمي', title: 'التفكير التصميمي', definition: 'منهج لحلّ المشكلات يبدأ من التعاطف مع الإنسان، ثم تحديد المشكلة وتوليد الأفكار والنمذجة والاختبار.' },
  { term: 'قلق الاختبار', title: 'قلق الاختبار', definition: 'توتر انفعالي مرتبط بمواقف التقييم قد يضعف الأداء والتركيز، ويتأثّر بتوقّعات الذات والمحيط.' },
  { term: 'تقدير الذات', title: 'تقدير الذات', definition: 'تقييم الفرد لقيمته ومكانته؛ حين يُعلّق بالكامل على الأداء والدرجة يصبح هشًّا وعرضة للاهتزاز.' },
  { term: 'الجاهزية المهنية', title: 'الجاهزية المهنية', definition: 'امتلاك أعضاء هيئة التدريس المعرفة والمهارة والاتجاه اللازم لتوظيف أداة أو ممارسة بفاعلية.' },
]
...
export function ReaderParagraphText({ text, popularQuotes = [] }: { text: string; popularQuotes?: PopularQuote[] }) {
  ...
  /* بحث لا يتأثر بالتشكيل: النص قد يكتب «التعلم» والقاموس «التعلّم»، والسوابق (وال/بال)
     تسبق المصطلح — فنبني نسخة مجرّدة من النص بخريطة مواضع تعيدنا للنص الأصلي بدقة،
     فيظهر التوضيح تلقائيًا حيثما ورد المصطلح مهما اختلف تشكيله أو سبقه حرف عطف. */
  const stripDia = (value: string) => value.replace(/[ًٌٍَُِّْٰـ]/g, '')
  const bareText: string[] = []
  const mapToOriginal: number[] = []
  for (let i = 0; i < text.length; i++) {
    if (/[ًٌٍَُِّْٰـ]/.test(text[i])) continue
    bareText.push(text[i]); mapToOriginal.push(i)
  }
  const bare = bareText.join('')
  const bareLower = bare.toLowerCase()
  for (const term of GLOSSARY) {
    const isLatin = /[A-Za-z]/.test(term.term)
    const needle = isLatin ? term.term.toLowerCase() : stripDia(term.term)
    const foundAt = (isLatin ? bareLower : bare).indexOf(needle)
    if (foundAt < 0) continue
    const start = mapToOriginal[foundAt]
    const end = (mapToOriginal[foundAt + needle.length - 1] ?? start) + 1
    if (start >= 0 && end > start) matches.push({ start, end, kind: 'term', term })
  }
