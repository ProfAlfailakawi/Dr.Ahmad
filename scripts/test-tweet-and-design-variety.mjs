...
const rendererUrl = await compile('src/lib/social-design-renderer.ts', { './social-design-engine': engineUrl, './seasons': await compile('src/lib/seasons.ts'), './design-system': designSystemUrl })
