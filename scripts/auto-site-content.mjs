...
const FAQ_FRAMES = [
  ...
  (topic) => `كيف نعرف أن «${topic}» أثّر فعلًا لا شكلًا؟`,
...
const FAQ_PRINCIPLES = {
  ...
  "الذكاء الاصطناعي والتعليم":
    "استخدم الذكاء الاصطناعي لتوسيع التفكير والمقارنة والتغذية الراجعة، لا ليحلّ محل المحاولة أو يقدّم ناتجًا لا يستطيع المتعلم شرحه.",
  "التربية الأسرية":
  ...
  "التقييم والقياس":
    "اجعل الدرجة مؤشرًا ضمن أدلة متعددة، واطلب تفسيرًا وتطبيقًا ومقارنة؛ فالفهم يظهر عندما تتحرك المعرفة في موقف جديد.",
  "التفكير النقدي":
    "ابنِ الحكم على سؤال ودليل ومقارنة بين البدائل، ثم اطلب من المتعلم أن يشرح سبب قراره لا أن يكرر النتيجة فقط.",
  "الهوية الرقمية":
    "تعامل مع الأثر الرقمي بوصفه امتدادًا للهوية: ما ننشره وما نسمح بجمعه وما نصدقه يحتاج وعيًا وحدودًا ومراجعة مستمرة.",
  "أخلاقيات التقنية":
  ...
  "التعلم الإلكتروني":
    "لا تنقل المحاضرة نفسها إلى شاشة؛ صمّم مهمة وتفاعلًا وتغذية راجعة، ثم تأكد أن المتعلم يستطيع الإنجاز لا المشاهدة فقط.",
  "المدارس الذكية":
    "المدرسة الذكية ليست مبنى مليئًا بالأجهزة؛ هي منظومة تستخدم البيانات والتقنية لتحسين قرار تربوي واضح مع حماية الإنسان وخصوصيته.",
  "التلعيب والألعاب التعليمية":
  ...
  "القيادة والابتكار":
    "حوّل الفكرة إلى تجربة صغيرة لها مسؤول وموعد ومؤشر أثر؛ فالابتكار الذي لا يدخل التشغيل يبقى عرضًا جميلًا.",
  "الإعلام والمجتمع الرقمي":
    "افصل بين سرعة الانتشار وصدق المحتوى، وراجع المصدر والسياق والمصلحة قبل المشاركة؛ فالتفاعل ليس دليلًا على الموثوقية.",
  "الصحة النفسية في البيئة التعليمية":
...
const FAQ_TAILS = [
  ...
  "وضوح الغاية قبل التنفيذ يمنع كثيرًا من الهدر.",
  "لا تجعل سهولة الأداة بديلًا عن جودة القرار.",
  "الممارسة اليومية أصدق من الشعار عند قياس النجاح.",
  "راجِع النتيجة مع من يتأثر بها، لا مع من صمّمها فقط.",
  "ما لا يمكن تفسيره للمتعلم أو الأسرة يحتاج تبسيطًا قبل اعتماده.",
