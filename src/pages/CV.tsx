        ...
        <div className="mx-auto max-w-shell">
          ...
          <FadeUp>
            ...
            <div className="mt-14 grid grid-cols-3 gap-2 sm:gap-4">
              <a href={cvLinks.ar} target="_blank" rel="noreferrer" aria-label="السيرة الذاتية الأكاديمية PDF" className="group rounded-2xl border border-accent/30 bg-accent/[.05] p-3 text-center transition-all duration-300 sm:p-6 hover:border-accent hover:bg-accent/10 hover:shadow-md">
                ...
                <span className="mt-2 block font-display text-[.78rem] font-bold text-ink sm:mt-4 sm:text-[1.05rem] transition-colors group-hover:text-accent">السيرة الذاتية الأكاديمية</span>
                <span className="mt-1 block text-[.72rem] font-semibold text-soft">PDF</span>
              </a>
              <a href="/files/Dr-Ahmad-Training-Profile.pdf" target="_blank" rel="noreferrer" aria-label="السيرة الذاتية التدريبية PDF" className="group rounded-2xl border border-hair bg-canvas p-3 text-center transition-all duration-300 sm:p-6 hover:border-accent hover:shadow-md">
                ...
                <span className="mt-2 block font-display text-[.78rem] font-bold text-ink sm:mt-4 sm:text-[1.05rem] transition-colors group-hover:text-accent">السيرة الذاتية التدريبية</span>
                <span className="mt-1 block text-[.72rem] font-semibold text-soft">PDF</span>
              </a>
              <a href="/files/Dr-Ahmad-Media-Kit.pdf" target="_blank" rel="noreferrer" aria-label="السيرة الذاتية الإعلامية PDF" className="group rounded-2xl border border-hair bg-canvas p-3 text-center transition-all duration-300 sm:p-6 hover:border-accent hover:shadow-md">
                <span aria-hidden className="mx-auto flex h-9 w-9 items-center sm:h-14 sm:w-14 justify-center rounded-full border border-accent/40 text-accent transition-colors group-hover:bg-accent group-hover:text-white">
                ...
                <span className="mt-2 block font-display text-[.78rem] font-bold text-ink sm:mt-4 sm:text-[1.05rem] transition-colors group-hover:text-accent">السيرة الذاتية الإعلامية</span>
                <span className="mt-1 block text-[.72rem] font-semibold text-soft">PDF</span>
              </a>
            </div>
          </FadeUp>
