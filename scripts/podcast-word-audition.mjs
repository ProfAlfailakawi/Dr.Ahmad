...
/* كل كلمةٍ شكا منها الدكتور (٢٠ أغسطس ٢٠٢٦) مع جملتها الحاملة من المتن.
   ...
   لا كلمة مخترعة هنا. */
const WORDS = [
  /* جولة حركات/همزة الوصل — بعد حكم v11 = ٨٥٪.
     نقارن في الجملة نفسها، ولا يدخل أي بديل من هني إلى المعجم
     قبل أن يختاره الدكتور برقمه. الخيار ٣ في كل موضع هو الكسرة
     التي خمّناها في v11 أو سمعنا المحرك يميل لها؛ هي مرجع مرفوض للمقارنة. */
  { key: 'نركظ', speaker: 'Noura',
    carrier: '{W} وايد… ونسمي الرَكْظ التزام.',
    options: ['نَرْكُظ', 'انْرَكُظ', 'نِرْكُظ'] },
  { key: 'نعرفه', speaker: 'Fahad',
    carrier: 'بس من داخلنا، قاعدين نأجل الشي اللي {W}.',
    options: ['نَعَرْفَه', 'انْعَرْفَه', 'نِعَرْفَه'] },
  { key: 'يبعدنا', speaker: 'Noura',
    carrier: 'نفرق بين شغل يقربنا من الشي المهم… وشغل {W} عنه.',
    options: ['يَبْعِدنا', 'ايْبَعِدنا', 'يِبْعِدنا'] },
  { key: 'يهرب', speaker: 'Noura',
    carrier: 'وبالأخير يكتشف إنه كان {W} من نفسه.',
    options: ['يَهْرُب', 'ايْهَرُب', 'يِهْرُب'] },
  { key: 'نتهرّب', speaker: 'Fahad',
    carrier: 'مرات ما تكون جدية أصلا… تكون طريقة مرتبة {W} فيها.',
    options: ['نَتْهَرَّب', 'انْتَهَرَّب', 'نِتْهَرَّب'] },
]
