...
const ARTICLE_FAMILIES = [
  ...
  },
  {
    ...
    move: 'negation',
    label: 'النفي المزدوج',
    plan: 'افتح بجملة نفيٍ قصيرة تُسقط افتراضاً شائعاً عند القارئ، تصوغها أنت من الفكرة نفسها؛ ولا تستعمل الصيغة الجاهزة «ليست المشكلة في… بل في…». ثم فكّك الفهم الشائع بحجةٍ لا بحكاية. ثم قل ما ينبغي أن نراه مكانه، مسنوداً بما في «من_مراجعك» أو «من_عندك» إن وُجد. واختم بما حدّده الختام أدناه.',
  },
  {
    id: 'question',
    move: 'question',
