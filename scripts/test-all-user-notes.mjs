...
check('عروض أبواب الموسوعة الأربعة مضمّنة كملفات تحميل فعلية', [1, 2, 3, 4].every((door) => exists(`files/encyclopedia/encyclopedia-door-${door}.pptx`)) && encyclopediaPortal.includes('download={`موسوعة تكنولوجيا التعليم - الباب ${door.number}.pptx`}'))
