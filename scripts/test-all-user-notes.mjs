...
check('ذيل المقال موحد تحت بعد القراءة والتنقل مستقل', articleDetail.includes('بعد القراءة') && articleDetail.includes('مشاركة المقال والاستشهاد به') && articleDetail.includes('جميع المقالات') && articleDetail.includes('السابق') && articleDetail.includes('التالي'))
