...
export type MultimodalMeaningCourt = { schemaVersion: 1; kind: 'multimodal-meaning-court'; fingerprintHash: string; status: SemanticCourtStatus; releaseReady: boolean; score: number; chambers: Record<'text' | 'audio' | 'design' | 'social' | 'sources', SemanticCourtChamber>; safeguards: Record<'headlineGuard' | 'caveatCovenant' | 'claimLineage', SemanticCourtSafeguard>; alerts: string[] }
