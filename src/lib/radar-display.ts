...
const SOURCE_LABELS: Record<string, string> = {
  ...
  "The Conversation AU": "ذا كونفرسيشن",
  "Inside Higher Ed": "إنسايد هاير إد",
  "KQED MindShift": "مايندشيفت — KQED",
  "The 74": "ذا 74",
  Nature: "دورية نيتشر",
  "Nature Human Behaviour": "نيتشر — السلوك الإنساني",
  "Scientific American": "ساينتفيك أمريكان",
  Science: "دورية ساينس",
  "Pew Research Center": "مركز بيو للأبحاث",
  Aeon: "مجلة إيون",
  "Phys.org": "فيز دوت أورغ",
  "Quanta Magazine": "مجلة كوانتا",
  "Harvard Gazette": "غازيت هارفارد",
  "The Guardian — Education": "الغارديان — التعليم",
  "OECD Education": "منظمة التعاون الاقتصادي — التعليم",
  Reuters: "رويترز",
