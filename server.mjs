...
const ARTICLE_FAMILIES = [
  ...
  },
  {
    ...
    move: 'scene',
    label: 'المشهد اليومي',
    plan: 'افتح بجملةٍ قصيرة بالمضارع ترسم لحظةً عامّة يعرفها كل بيتٍ أو صفٍّ كويتي، تختارها أنت من الفكرة نفسها، بلا بطلٍ مسمّى ولا «أنا» ولا حوار، ولا يتجاوز المشهد فقرته الأولى. ثم اكشف ما يخفيه عن أبنائنا. ثم اسنده بما في «من_مراجعك» أو «من_عندك» إن وُجد. واختم بما حدّده الختام أدناه.',
  },
  {
    id: 'we',
    move: 'we',
