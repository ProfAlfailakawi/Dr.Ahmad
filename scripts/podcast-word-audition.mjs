...
/* كل كلمةٍ شكا منها الدكتور (٢٠ أغسطس ٢٠٢٦) مع جملتها الحاملة من المتن.
   ...
   لا كلمة مخترعة هنا. */
const WORDS = [
  /* ═══ الجولة الخامسة عشرة (٢٢ أغسطس ٢٠٢٦) — من حكم تجربة التسعة ═══
     ثلاث كلمات أخطأت في **كل** الأذرع الثلاثة (فالعلة في الكلمة لا في
     الرأس)، وواحدة تختبر علاج قلقلة القاف التي سمعها في المقطعين
     الممتازين ٣ و٥. الجمل بإملاء مدخل الصوت الحالي. */

  /* «معركة بقاء» — سمعها مفخّمة في ٣ و٥. الهمزة الأخيرة + القاف تثقلانها.
     البديلان: تشكيل يخفف، أو كلمة كويتية بلا همزة ولا قاف. */
  { key: 'بقاء', speaker: 'Fahad',
    carrier: 'لما الامتحان يتحول لمعركة {W}، النجاح ما يصير بداية وعي.',
    options: ['بقاء', 'بَقا', 'عيش'] },

  /* «ما يطمنه» — سقطت مرتين بإملاءين (ايطمنه ثم يطمنه). فالثالثة
     استبدال الجملة كاملة كما فعلنا مع «يعرفها». */
  { key: 'ما يطمنه — جملة', speaker: 'Fahad',
    carrier: 'لأنه {W}؛ بس يأجل خوفه للاختبار الياي.',
    options: ['ما يطمنه من داخل', 'ما يريحه من داخل', 'ما يهدي باله'] },

  /* «يعرفها بعقله» — سقطت أربع مرات (عارفها · داري فيها · يدريها ·
     يعرفها). استبدال الجملة كاملة، والبدائل بلا فعل المعرفة أصلاً. */
  { key: 'يعرفها بعقله — جملة', speaker: 'Fahad',
    carrier: '{W}. بس الإحساس مو دايما يسمع كلام العقل.',
    options: ['يعرفها بعقله، إي', 'عقله متقبلها، إي', 'مخه يقول صح، إي'] },

  /* قلقلة القاف — جملة الختام فيها ثلاث قافات وتتكرر في كل حلقة،
     فهي أوضح موضع للقلقلة. نختبر تخفيفها بالتشكيل. */
  { key: 'جملة الختام — قلقلة القاف', speaker: 'Noura',
    carrier: 'وإذا تبي الفكرة كاملة، {W}.',
    options: ['تلقى المقال الأصلي في موقع الدكتور أحمد حسين الفيلچاوي',
              'تلقَى المقال الأصلي في مَوقع الدكتور أحمد حسين الفيلچاوي',
              'تحصل المقال الأصلي في موقع الدكتور أحمد حسين الفيلچاوي'] },
]
