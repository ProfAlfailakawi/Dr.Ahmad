...
export const THRESHOLDS = {
  ...
  nameInClosing: true,  /* «موقع الدكتور أحمد» في الختام المنطوق */
}
...
function report (per) {
  ...
  console.log('وإعادة سطر الإحالة كاملاً بإحدى الصيغ المعتمدة إلى «موقع الدكتور أحمد».')
  return 1
}

if (SELF_TEST) {
  const good = { ep: [{ text: 'ترى هالشي وايد مهم، شنو رايك؟' }, { text: 'إي صج، بس عقب جذي شلون نسوي؟' },
    { text: 'وإذا تبي الفكرة كاملة، تلقى المقال الأصلي في موقع الدكتور أحمد.' }] }
