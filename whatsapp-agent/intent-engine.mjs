...
const patterns = [
  ...
  /* «فصول الكتاب» كانت تُفهم، و«فصول المدارس الذكية» لا — وهي المثال الذي
     يقترحه البوت بنفسه حين يسأل «أي كتاب تقصد؟». كان الشرط يوجب كلمة «كتاب»
     بعد «فصول»، فيسقط اسمُ الكتاب الصريح إلى بحثٍ عام يردّ بمختارات.
     الآن يُقبل الاسم مباشرةً، وتُستثنى أبواب الموقع حتى لا نخطف «محتويات
     الموقع». وإن لم يُطابق اسمٌ كتاباً، يعود المتحكّم إلى البحث العام. */
  [INTENTS.BOOK_CHAPTERS, [/^(?:(?:ابي|اريد|ابغي|ابغى|ممكن|عطني|اعطني|ورني|وريني)\s+)?(?:فصول|ابواب|محتويات|فهرس)\s+(?!(?:ال)?موقع|الموقع)(?:(?:ال)?كتاب(?:\s+.+)?|[^\s].{1,60}?)[!.؟]*$|^(?:(?:ابي|اريد|ابغي|ابغى|ممكن|عطني|اعطني|ورني|وريني)\s+)?(?:فصول|ابواب|محتويات|فهرس)\s*(?:ال)?كتاب(?:\s+.+)?[!.؟]*$|^(?:فصوله|ابوابه|محتوياته|فهرسه)[!.؟]*$/, 0.99],
  ...
  /* «القادمة» كانت اختيارية، فصار كل من كتب «ابي لقاءات عن كذا» يُساق إلى صفحة
     اللقاءات القادمة بدل الأرشيف الإعلامي. صفة الاستقبال شرطٌ الآن: بلا كلمةٍ
     تدلّ على المستقبل يبقى السؤال عن الأرشيف، وهو الأشيع. */
  [INTENTS.UPCOMING_EVENTS, [/(لقاءات|محاضرات|فعاليات|مشاركات|ندوات|مؤتمرات)\s*(ال)?(قادمه|القادمه|الجايه|الجايات|المقبله)|(وين|متي)\s*(بتكون|راح تكون)?\s*(محاضرتك|لقاءك|ندوتك)/, 0.93]],
