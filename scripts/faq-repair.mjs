 ...
 *   «كيف نعرف أن تطبيق «{الموضوع}» يحقق أثرًا حقيقيًا؟»
...
const TEMPLATE_Q = /^كيف نعرف أن تطبيق «[^»]*» يحقق أثرًا حقيقيًا؟$/
...
function selfTest() {
  const templated = {
    q: { stringValue: 'كيف نعرف أن تطبيق «التربية الأسرية» يحقق أثرًا حقيقيًا؟' },
  ...
  const lookalike = {
    q: { stringValue: 'كيف نعرف أن التقييم الجديد يحقق أثرًا في الصف؟' },
