...
console.log('\nالرسائل والسرعة')
check('الرسائل التمثيلية قصيرة ومتنوعة وموسومة بوضوح', count(inbox, 'source: "editorial"') >= 8 && inbox.includes('نموذج تمثيلي') && inbox.includes('ولي أمر') && inbox.includes('معلمة') && inbox.includes('طالب دراسات عليا'))
