...
export const NATIVE_SPOKEN_VERSION = '2026-08-31-native-kuwaiti-v22-ear-safe-verbs'
...
const SAFE_TEXT_RULES = [
  ...
  /* [٣١ أغسطس ٢٠٢٦] الأذن سمعت «ما انختبروا» كأنها «ما نختبرو»،
     و«نقعد نصفق طويل» ابتلعت نهايتها. المشكلة تركيبية، لذلك نحذف
     عائلتي الفعل من مدخل الصوت كله، ونبقي حارساً قاطعاً لأي سياق جديد. */
  [/بس الحقيقة إنهم ما انختبروا بشي أبدا\.?/gu, 'بس الحقيقة إنهم ما مرّوا بتجربة فعلية أبد.'],
  [/والكويت اليوم ما تنختبر بقوة دفاعها بس… تنختبر بقوة تماسكها\.?/gu,
    'والكويت اليوم مو بس قوتها بدفاعها… قوتها بعد بتماسكها.'],
  [/العقل اللي ما ينختبر بسؤال/gu, 'العقل اللي محد سأله سؤال صعب'],
  [/(?:في حفلات التخرج )?(?:نقعد )?نصفّ?ق طويل(?:ا|\u064Bا)? لصاحب الامتياز/gu,
    'في حفلات التخرج نحتفل بصاحب الامتياز وايد'],
  [/ونصفّ?ق للدقة/gu, 'ونمدح الدقة'],
  [/صرنا نصفّ?ق للشعارات/gu, 'صرنا نتحمس للشعارات'],
  [/وبعدين نصفّ?ق له لأنه ما أزعجنا/gu, 'وبعدين نمدحه لأنه ما أزعجنا'],
  [/ماكو أحد يصفّ?ق له/gu, 'ماكو أحد يمدحه عليه'],
  [/ترى الجماهير تصفّ?ق/gu, 'وترى الكل يحتفل'],
  [/وإحنا نصفّ?ق لأنه ساكت؟/gu, 'وإحنا مبسوطين لأنه ساكت؟'],
  [/تصفّ?ق له وهو ما يدري/gu, 'تمدحه وهو ما يدري'],
  [/المسؤولية ما تقع على المدرسة وحدها… واليد الوحدة ما تصفّ?ق/gu,
    'المسؤولية مو على المدرسة بروحها… والشغل ما يمشي بيد وحدة'],
  [/فالحقيقة ما تبي جمهور يصفّ?ق… تبي عقول تصبر/gu,
    'فالحقيقة تبي ناس تفكر وتصبر… مو جمهور يمدح'],
  ...
  [/نقيم قدرة الطالب على استخدام هالأدوات الذكية، بدال ما نختبر نضجه الفكري/gu,
    'نقيم قدرة الطالب على استخدام هالأدوات الذكية، وننسى نشوف نضجه الفكري'],
...
export const RISK_PATTERNS = [
  ...
  ['تركيب سمعي مرفوض', /(?:نصفّ?ق|يصفّ?ق(?:ون)?|تصفّ?ق|صفّ?قوا|نختبر(?:ه|هم|ها|وا|و)?|ينختبر|تنختبر|انختبروا?)/u],
  ['لغة مقالة موزعة على صوتين', /(?:تغلف فراغ|العقل يتقاس بورقة|وفي المشهد الرمزي|(?:النص|المقال) (?:يقول|يوضح|يذكر|يسأل|يقترح|ما يعمم|يرجع|ينصف|يلوم|سابقك)|مصانع ألقاب|مهرجان ألقاب|نكرر أوراق مطبوعة|العقل اللي انغيب تحتها|جمهورية شهادات)/u],
]
