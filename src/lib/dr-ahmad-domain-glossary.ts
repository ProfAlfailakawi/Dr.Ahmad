...
export const DR_AHMAD_DOMAIN_FACETS: DomainFacet[] = [
  ...
  facet('audience', 'faculty', 'أعضاء هيئة التدريس', 'Faculty Members', ['عضو هيئة تدريس', 'استاذ جامعي', 'أستاذ جامعي', 'faculty', 'professor', 'academics'], 'أعضاء هيئة التدريس بوصفهم مصممي تعلم وباحثين وقادة للممارسة الجامعية.', 'أستاذ جامعي يراجع قراراً أو يصمم تجربة', ['academic', 'human'], ['human-documentary', 'daylight-learning']),
  facet('audience', 'teachers', 'المعلمون', 'Teachers', ['معلم', 'معلمين', 'مدرس', 'teacher', 'teachers'], 'المعلمون بوصفهم ميسرين ومصممين ومقوّمين للعلاقات والخبرات التعليمية.', 'معلم يقود تفاعلاً أصيلاً لا صورة صفية مصطنعة', ['human', 'bright'], ['optimistic-human', 'human-documentary']),
  ...
  facet('context', 'early-childhood', 'الطفولة المبكرة', 'Early Childhood', ['روضة', 'حضانة', 'طفولة مبكرة', 'early childhood', 'kindergarten'], 'مرحلة نمائية تحتاج تعلماً باللعب وعلاقة آمنة وخبرات حسية مناسبة.', 'مواد تعلم ملموسة وألوان راقية وحركة آمنة', ['playful', 'warm'], ['playful-systems', 'tactile-learning']),
  ...
  facet('context', 'remote-learning', 'التعلّم عن بُعد', 'Remote Learning', ['عن بعد', 'remote', 'distance'], 'تعلم مع انفصال مكاني يحتاج اتصالاً وتصميماً ودعماً وتفاعلاً.', 'مساحتان مضيئتان يربطهما مسار تعلم', ['human', 'optimistic'], ['optimistic-human', 'daylight-learning']),
  ...
  facet('context', 'classroom', 'الصف الدراسي', 'Classroom', ['فصل', 'صف', 'classroom'], 'الموقف الصفي بوصفه علاقة ونشاطاً وتفاعلاً وتقويماً لا مكاناً فارغاً فقط.', 'صف حي ومضيء تظهر فيه مهمة أو علاقة واضحة', ['bright', 'human'], ['daylight-learning', 'optimistic-human']),
  ...
  facet('action', 'develop', 'التطوير', 'Development', ['تطوير', 'تحسين', 'develop', 'improve'], 'بناء الحل وتحسينه تكرارياً اعتماداً على الأدلة والتغذية الراجعة.', 'تطور مرئي بين نموذج أولي ونسخة ناضجة', ['creative', 'optimistic'], ['living-learning-lab', 'tactile-learning']),
  facet('action', 'integrate', 'الدمج والتوظيف', 'Integration and Use', ['دمج', 'توظيف', 'استخدام', 'integrate', 'use'], 'توظيف الأداة داخل هدف وسياق وممارسة بدل إضافتها شكلياً.', 'أداة تصبح جزءاً طبيعياً من مسار التعلم', ['balanced', 'human'], ['daylight-learning', 'kinetic-system']),
  ...
  facet('action', 'analyze', 'التحليل', 'Analysis', ['تحليل', 'analyze', 'analysis'], 'تفكيك البيانات أو الفكرة واكتشاف العلاقات والأنماط والتفسيرات.', 'عناصر يعاد ترتيبها لتكشف نمطاً', ['academic', 'precise'], ['forensic-still-life', 'paper-sculpture']),
  facet('action', 'predict', 'التنبؤ', 'Prediction', ['تنبؤ', 'استشراف', 'predict', 'forecast'], 'تقدير نتائج مستقبلية اعتماداً على بيانات وافتراضات مع التعبير عن عدم اليقين.', 'مسارات محتملة لا كرة بلورية', ['future', 'data'], ['kinetic-system', 'visual-paradox']),
  ...
  facet('method', 'qualitative', 'المنهج النوعي', 'Qualitative Method', ['نوعي', 'كيفي', 'qualitative'], 'منهج يفسر المعنى والخبرة والسياق من بيانات غنية.', 'أصوات وتجارب متعددة تظهر أنماطاً', ['human', 'intellectual'], ['human-documentary', 'archival-future']),
