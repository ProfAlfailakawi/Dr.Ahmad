...
export const profile = {
  ...
  facts: [
    ...
    'PAAET · جامعة الكويت',
    'مؤلفات منشورة في تكنولوجيا التعليم',
    'أبحاث علمية محكّمة',
...
const bookTocs: Record<string, string> = {
  encyclopedia: [
    'الباب الأول: مفهوم تكنولوجيا التعليم',
    'الفصل الأول: المفاهيم الأساسية في تكنولوجيا التعليم — ص 36',
    'الفصل الثاني: نظرة تاريخية في تكنولوجيا التعليم — ص 82',
    'الفصل الثالث: التعليم ونظرية الاتصال التعليمي — ص 126',
    'الفصل الرابع: التصميم التعليمي — ص 154',
    'الفصل الخامس: نظريات التعلم ونماذجه — ص 194',
    'الباب الثاني: مستحدثات تكنولوجيا التعليم',
    'الفصل الأول: المستحدثات التكنولوجية — ص 242',
    'الفصل الثاني: الإنترنت في التعليم — ص 260',
    'الفصل الثالث: الحاسوب التعليمي — ص 294',
    'الفصل الرابع: استراتيجيات التعليم بمساعدة الحاسب الآلي — ص 312',
    'الفصل الخامس: التعليم الإلكتروني والتعليم عن بُعد — ص 332',
    'الباب الثالث: نماذج مستحدثات تكنولوجيا التعليم',
    'الفصل الأول: نماذج التعليم الإلكتروني والتعليم عن بُعد — ص 364',
    'الفصل الثاني: العالم الافتراضي — ص 388',
    'الفصل الثالث: تكنولوجيا الوسائل التعليمية — ص 412',
    'الفصل الرابع: برمجيات الحاسب الآلي التطبيقية — ص 458',
    'الفصل الخامس: نماذج الشبكة العنكبوتية في التعليم — ص 488',
    'الفصل السادس: الأجهزة الذكية في التعليم — ص 528',
    'الباب الرابع: المعلم والتكنولوجيا — ص 554',
    'الفصل الأول: القرن الحادي والعشرين والتعليم — ص 556',
    'الفصل الثاني: مستويات بلوم وتكنولوجيا التعليم — ص 570',
    'الفصل الثالث: الفجوة الرقمية — ص 578',
    'الفصل الرابع: من التعلم التقليدي إلى التعلم التفاعلي — ص 596',
    'الفصل الخامس: التكنولوجيا كأداة للتغيير — ص 614',
    'الباب الخامس: الدراسات السابقة لمستحدثات تكنولوجيا التعليم — ص 636',
    'الخاتمة — ص 658',
    'قائمة المراجع — ص 686',
  ].join('\n'),
  teaching: [
    'مقدمة — ص 8',
    'دمج التكنولوجيا في المنهاج — ص 12',
    'استخدام التكنولوجيا في الفصل — ص 15',
    'دور تكنولوجيا التعليم في تطوير المنهج — ص 22',
    'أهمية تطوير المناهج في التعليم — ص 27',
    'تصميم التدريس — ص 30',
    'استخدام الحاسوب في التعليم — ص 33',
    'تطبيقات الحاسوب في التعليم — ص 49',
    'البرامج التعليمية المحوسبة — ص 51',
    'علم النفس التربوي — ص 55',
    'التعلم عن بُعد — ص 70',
    'التعلم الإلكتروني — ص 72',
    'تصميم التدريس في بيئات التعلم الإلكتروني — ص 76',
    'تطبيقات برامج الوسائط المتعددة في التعليم — ص 83',
    'أنظمة إدارة التعلم — ص 88',
    'شبكات المعلومات والتعلم الإلكتروني — ص 93',
    'إنتاج الفيديو التعليمي — ص 97',
    'الإنفوجرافيك التعليمي — ص 106',
    'منظمو الجرافيك — ص 115',
    'تصميم المواقع التعليمية — ص 116',
    'الألعاب والرسوم المتحركة في التدريس — ص 123',
    'التعلم القائم على الرسوم المتحركة — ص 129',
    'التصوير الفوتوغرافي الرقمي في التدريس — ص 140',
    'الروبوت التعليمي — ص 151',
    'الخاتمة — ص 161',
    'قائمة المراجع — ص 162',
  ].join('\n'),
  'mega-data': [
    'مقدمة — ص 6',
    'مفهوم الذكاء الاصطناعي وعلم البيانات ونشأته — ص 9',
    'أهمية الذكاء الاصطناعي وعلم البيانات — ص 14',
    'مجالات الذكاء الاصطناعي وتطبيقاته — ص 16',
    'ما هو حوكمة الذكاء الاصطناعي؟ — ص 21',
    'أخلاقيات الذكاء الاصطناعي — ص 24',
    'أخلاقيات الآلة — ص 30',
    'ما هي حوكمة البيانات؟ — ص 32',
    'لماذا تعتبر حوكمة البيانات مهمة؟ — ص 34',
    'استراتيجيات حوكمة البيانات — ص 36',
    'لماذا تعد حوكمة البيانات ضرورية لنجاح الذكاء الاصطناعي؟ — ص 37',
    'كيف تبدو الإدارة الجيدة للبيانات في الذكاء الاصطناعي؟ — ص 39',
    'من حوكمة البيانات إلى حوكمة الذكاء الاصطناعي — ص 40',
    'دور الذكاء الاصطناعي في إدارة البيانات — ص 44',
    'كيف تعمل البيانات الضخمة والذكاء الاصطناعي معاً؟ — ص 47',
    'دمج الذكاء الاصطناعي والبيانات الضخمة — ص 50',
    'تحديات الذكاء الاصطناعي وحوكمة البيانات — ص 56',
    'ما التالي بالنسبة للذكاء الاصطناعي والبيانات الضخمة؟ — ص 59',
    'إطار جديد — ص 62',
    'الخاتمة — ص 68',
    'قائمة المراجع — ص 70',
  ].join('\n'),
  'handy-tech': [
    'مقدمة — ص 6',
    'تعريف ذوي الاحتياجات الخاصة وأنواعها — ص 9',
    'أنواع فئات ذوي الاحتياجات الخاصة وحاجاتهم — ص 11',
    'مفهوم تكنولوجيا التعليم لذوي الاحتياجات الخاصة وأهميتها — ص 14',
    'أهمية الوسائل التعليمية والتكنولوجية في تعليم الطلبة ذوي الاحتياجات — ص 18',
    'صفات الوسيلة التقنية الناجحة — ص 23',
    'استخدام التكنولوجيا لخدمة وتمكين الطلاب ذوي الاحتياجات الخاصة — ص 24',
    'التكنولوجيا المساعدة للإعاقات الجسدية — ص 28',
    'دور تكنولوجيا التعليم في تقديم حلول لذوي الاحتياجات الخاصة — ص 32',
    'استخدام الحاسوب لتعليم ذوي الاحتياجات الخاصة — ص 35',
    'فوائد التعليم الإلكتروني لذوي الاحتياجات الخاصة — ص 36',
    'التعليم الافتراضي والوسائط المتعددة — ص 42',
    'الواقع المعزز لتعليم ذوي الاحتياجات الخاصة — ص 52',
    'فوائد الأجهزة المحمولة على الأطفال ذوي الاحتياجات الخاصة — ص 54',
    'التكنولوجيا المساعدة وتطبيقاتها — ص 58',
    'كيف ساعدت التكنولوجيا الرقمية على التعايش مع الإعاقة؟ — ص 69',
    'عقبات الاستفادة من التكنولوجيا — ص 74',
    'الخاتمة — ص 78',
    'قائمة المراجع — ص 80',
  ].join('\n'),
  'smart-school': [
    'مقدمة — ص 7',
    'مفهوم المدرسة الذكية ومنفعتها — ص 10',
    'ما هي الفصول الذكية؟ — ص 12',
    'سمات مدرسة المستقبل — ص 14',
    'مواصفات ومتطلبات المدرسة الذكية وأهدافها — ص 17',
    'توظيف التكنولوجيا في المدرسة الذكية — ص 18',
    'تطبيقات مفهوم المدرسة الذكية في تطوير التعليم العام — ص 19',
    'مواصفات مبنى المدرسة الذكية — ص 25',
    'أنواع الفصول الذكية — ص 29',
    'التعليم التكنولوجي في المدارس الذكية — ص 32',
    'كيفية التحاق طلاب المدارس الذكية — ص 34',
    'متطلبات معلمي المدارس الذكية التنموية — ص 36',
    'المنهاج للمدارس الذكية — ص 42',
    'أساليب التدريس في المدارس الذكية — ص 43',
    'مساحة الصانع — ص 47',
    'الطلبة ذوو صعوبات التعلم في المدرسة الذكية — ص 81',
    'واقع المدرسة الذكية في الدول العربية ودولة الكويت — ص 87',
    'الخاتمة — ص 98',
    'قائمة المراجع — ص 100',
  ].join('\n'),
  'virtual-world': [
    'مقدمة — ص 6',
    'مفهوم العالم الافتراضي — ص 8',
    'مفاهيم العالم الافتراضي — ص 10',
    'أنواع العوالم الافتراضية — ص 13',
    'التطبيقات الرئيسية للواقع الافتراضي — ص 14',
    'استخدام الواقع الافتراضي في التعليم — ص 15',
    'الواقع المعزز — ص 23',
    'جاذبية الواقع المعزز وإمكانياته — ص 25',
    'أنواع الواقع المعزز — ص 27',
    'التطبيقات الرئيسية للواقع المعزز — ص 29',
    'استخدام الواقع المعزز في التعليم — ص 30',
    'الفرق بين الواقع الافتراضي والواقع المعزز — ص 39',
    'وظائف في صناعة الواقع الافتراضي والواقع المعزز — ص 43',
    'الواقع المختلط — ص 44',
    'العالم الافتراضي القادم — ص 49',
    'تكنولوجيا العالم الافتراضي — ص 53',
    'الخلايا العصبية الإلكترونية — ص 58',
    'مستقبل تخصص الواقع الافتراضي والواقع المعزز — ص 61',
    'تطور العلم والتكنولوجيا — ص 66',
    'الخاتمة — ص 72',
    'قائمة المراجع — ص 74',
  ].join('\n'),
  'kids-tech': [
    'مقدمة — ص 6',
    'اتجاهات التكنولوجيا في القرن الحادي والعشرين — ص 8',
    'التكنولوجيا وإيجابياتها ومهارات الطفل الاجتماعية — ص 10',
    'الإفراط في القلق بشأن الإفراط في الاتصال — ص 12',
    'تأثير التكنولوجيا على الأطفال والمراهقين — ص 14',
    'التلفاز وألعاب الفيديو ووسائل التواصل — ص 20',
    'آثار وعواقب العلاقة المتوترة حول التكنولوجيا — ص 28',
    'الآثار المترتبة على الصحة البدنية والتربية — ص 30',
    'ماذا يمكن للمدارس أن تفعل؟ — ص 35',
    'عمل السلامة الإلكترونية — ص 39',
    'للحد من التكنولوجيا على تربية الطفل — ص 41',
    'اتجاهات المستقبل في إشراك المراهقين بالتكنولوجيا — ص 51',
    'هل أصبح العالم الافتراضي أسلوب حياة؟ — ص 57',
    'مواكبة التطور التكنولوجي في تنمية المهارات المستقبلية للأطفال — ص 68',
    'مستويات المهارات الرقمية — ص 70',
    'المهارات المطلوبة لتعلم الأطفال علم الروبوتات — ص 74',
    'مهارات المستقبل — ص 75',
    'الخاتمة — ص 78',
    'قائمة المراجع — ص 80',
  ].join('\n'),
  gamification: [
    'مقدمة — ص 6',
    'ما هو التلعيب؟ — ص 9',
    'ما هو التلعيب في التعليم؟ — ص 10',
    'نشأة التلعيب — ص 11',
    'الصفات الأساسية للعب — ص 16',
    'أهداف تلعيب بيئات التعلم — ص 17',
    'فوائد وخصائص التلعيب في التعليم — ص 18',
    'الفرق بين اللعب والتعلم باللعب والتلعيب — ص 24',
    'أهمية التلعيب والألعاب الرقمية في التعليم — ص 27',
    'من الألعاب إلى التلعيب — ص 30',
    'المشكلات الرئيسية في ممارسات التلعيب — ص 32',
    'تقنيات التلعيب — ص 34',
    'كيف يمكن دمج عناصر التلعيب في الصف؟ — ص 40',
    'فوائد التلعيب على التعليم في الفصول الدراسية — ص 43',
    'التلعيب في التعليم عن بُعد — ص 44',
    'خطوات تنفيذ التلعيب في التعليم — ص 51',
    'إيجابيات التلعيب في التعليم — ص 53',
    'التطبيقات القائمة على التلعيب — ص 56',
    'التلعيب ومستقبل التعليم — ص 61',
    'أمثلة ناجحة على التلعيب — ص 63',
    'انتقادات تعليم التلعيب — ص 68',
    'الخاتمة — ص 72',
    'قائمة المراجع — ص 74',
  ].join('\n'),
  'digital-education': [
    'مقدمة — ص 7',
    'مفهوم التعلم الرقمي — ص 10',
    'أهداف التعلم الرقمي المعاصر وأهميته — ص 12',
    'التعليم العصري وخصوصياته في الزمن الرقمي — ص 15',
    'فوائد التعلم الرقمي عبر أساليب التعليم التقليدية — ص 17',
    'خصائص عملية التعلم في ظل العصر الرقمي — ص 19',
    'الأدوار الجديدة للمؤسسات التعليمية — ص 25',
    'المهارات المطلوبة في العصر الرقمي — ص 30',
    'متطلبات وحاجات كل طالب في العصر الرقمي — ص 34',
    'المعلم الرقمي لبيئة تعليمية رقمية — ص 38',
    'مهارات المعلم الرقمي — ص 43',
    'تطوير ورفع كفاءة المعلم الرقمي — ص 46',
    'سياسة التعليم والتدريب الأولي للمعلمين — ص 49',
    'تنمية مهارات المعلمين — ص 51',
    'الكفاءة الرقمية للمعلم — ص 56',
    'تطبيق نموذجي TPACK وSAMR لدمج التقنية — ص 59',
    'استخدام أدوات مايكروسوفت لدمج التقنية — ص 76',
    'الخاتمة — ص 80',
    'قائمة المراجع — ص 82',
  ].join('\n'),
}
...
export const books = [
  { slug: 'encyclopedia', coAuthors: 'د. عبدالعزيز دخيل العنزي', title: 'موسوعة تكنولوجيا التعليم', isbn: '978-99966-1-281-7',
    cover: '/covers/encyclopedia.webp',
    pdf: '/files/encyclopedia.pdf',
    pdfPolicy: 'sample',
    year: '2016', edition: 'الطبعة الأولى', publisher: 'المؤلفون', pageCount: '696', toc: bookTocs.encyclopedia,
  ...
  { slug: 'teaching', coAuthors: 'د. عبدالعزيز دخيل العنزي', title: 'مناهج وطرق التدريس (تكنولوجيا التعليم)', isbn: '978-9921-0-2023-6',
    cover: '/covers/teaching.webp',
    pdf: '/files/teaching.pdf',
    pdfPolicy: 'sample',
    year: '2021', edition: 'الطبعة الأولى', publisher: 'المؤلفون', pageCount: '200', toc: bookTocs.teaching,
  ...
  { slug: 'mega-data', coAuthors: 'د. عبدالعزيز دخيل العنزي', title: 'حوكمة الذكاء الاصطناعي والبيانات الضخمة', isbn: '978-9921-0-2013-7',
    cover: '/covers/mega-data.webp',
    pdf: '/files/mega-data.pdf',
    pdfPolicy: 'sample',
    year: '2021', edition: 'الطبعة الأولى', publisher: 'المؤلفون', pageCount: '84', toc: bookTocs['mega-data'],
  ...
  { slug: 'handy-tech', coAuthors: 'د. عبدالعزيز دخيل العنزي', title: 'تكنولوجيا ذوي الاحتياجات الخاصة', isbn: '978-9921-0-2015-1',
    cover: '/covers/handy-tech.webp',
    pdf: '/files/handy-tech.pdf',
    pdfPolicy: 'sample',
    year: '2021', edition: 'الطبعة الأولى', publisher: 'المؤلفون', pageCount: '100', toc: bookTocs['handy-tech'],
  ...
  { slug: 'smart-school', coAuthors: 'د. عبدالعزيز دخيل العنزي', title: 'المدارس الذكية', isbn: '978-9921-0-2022-9',
    cover: '/covers/smart-school.webp',
    pdf: '/files/smart-school.pdf',
    pdfPolicy: 'sample',
    year: '2021', edition: 'الطبعة الأولى', publisher: 'المؤلفون', pageCount: '120', toc: bookTocs['smart-school'],
  ...
  { slug: 'virtual-world', coAuthors: 'د. عبدالعزيز دخيل العنزي', title: 'العالم الافتراضي', isbn: '978-9921-0-2020-5',
    cover: '/covers/virtual-world.webp',
    pdf: '/files/virtual-world.pdf',
    pdfPolicy: 'sample',
    year: '2021', edition: 'الطبعة الأولى', publisher: 'المؤلفون', pageCount: '88', toc: bookTocs['virtual-world'],
  ...
  { slug: 'kids-tech', coAuthors: 'د. عبدالعزيز دخيل العنزي', title: 'الطفل والتكنولوجيا', isbn: '978-9921-0-2021-2',
    cover: '/covers/kids-tech.webp',
    pdf: '/files/kids-tech.pdf',
    pdfPolicy: 'sample',
    year: '2021', edition: 'الطبعة الأولى', publisher: 'المؤلفون', pageCount: '112', toc: bookTocs['kids-tech'],
  ...
  { slug: 'gamification', coAuthors: 'د. عبدالعزيز دخيل العنزي', title: 'التلعيب Gamification وعالم الألعاب', isbn: '978-9921-0-2019-9',
    cover: '/covers/gamification.webp',
    pdf: '/files/gamification.pdf',
    pdfPolicy: 'sample',
    year: '2021', edition: 'الطبعة الأولى', publisher: 'المؤلفون', pageCount: '100', toc: bookTocs.gamification,
  ...
  { slug: 'digital-education', coAuthors: 'د. عبدالعزيز دخيل العنزي', title: 'التعليم ومتطلبات العصر.. (التعلم الرقمي)', isbn: '978-9921-0-2018-2',
    cover: '/covers/digital-education.webp',
    pdf: '/files/digital-education.pdf',
    pdfPolicy: 'sample',
    year: '2021', edition: 'الطبعة الأولى', publisher: 'المؤلفون', pageCount: '96', toc: bookTocs['digital-education'],
    desc: 'التعلّم الرقمي ومتطلبات القرن الحادي والعشرين.' },
]

export const papers = researchPapers
...
export const media = [
  { title: 'لقاء في برنامج «معاكم» على تلفزيون دولة الكويت حول مشروع التعليم عن بعد', outlet: 'تلفزيون الكويت', channel: 'تلفزيون دولة الكويت', program: 'معاكم', url: 'https://www.youtube.com/watch?v=ydhZ9IcGaVc', iso: '2020-04-03', date: '3 أبريل 2020', duration: '00:04:09', topics: 'التعليم عن بُعد، استمرارية التعليم، التجربة الكويتية' },
  { title: 'لقاء في تلفزيون الكويت — تكنولوجيا التعليم', outlet: 'تلفزيون الكويت', channel: 'تلفزيون دولة الكويت', program: 'لقاء تلفزيوني', url: 'https://www.youtube.com/watch?v=MdMDpX9jwTU', iso: '2016-02-05', date: '5 فبراير 2016', duration: '00:09:29', topics: 'تكنولوجيا التعليم، التعلم الإلكتروني، دور التقنية في التعليم' },
  { title: 'برنامج «البيت العود» على قناة إثراء — مفهوم تكنولوجيا التعليم', outlet: 'قناة إثراء', channel: 'قناة إثراء', program: 'البيت العود', url: 'https://www.youtube.com/watch?v=UsO9ju--z2M', iso: '2016-05-04', date: '4 مايو 2016', duration: '00:23:53', topics: 'مفهوم تكنولوجيا التعليم، التعليم الإلكتروني، التعليم عن بُعد' },
  { title: 'برنامج «مساء الخير يا كويت» — حديث حول تكنولوجيا التعليم', outlet: 'تلفزيون الكويت', channel: 'تلفزيون دولة الكويت', program: 'مساء الخير يا كويت', url: 'https://www.youtube.com/watch?v=x_nNolE8DuM', iso: '2016-04-19', date: '19 أبريل 2016', duration: '00:12:08', topics: 'تكنولوجيا التعليم، التعلم الإلكتروني، الحاسوب في التعليم' },
  { title: 'برنامج «حدد مسارك» — نصائح للشباب (2): المهارات', outlet: 'حدد مسارك', channel: 'برنامج حدد مسارك', program: 'حدد مسارك', url: 'https://www.youtube.com/watch?v=cOlGZibqDiw', iso: '2016-06-06', date: '6 يونيو 2016', duration: '00:08:24', topics: 'مهارات الشباب، التعلم، بناء المسار' },
  { title: 'برنامج «حدد مسارك» — نصائح للشباب', outlet: 'حدد مسارك', channel: 'برنامج حدد مسارك', program: 'حدد مسارك', url: 'https://www.youtube.com/watch?v=-6BvLvZqTik', iso: '2016-05-27', date: '27 مايو 2016', duration: '00:07:32', topics: 'الشباب، التعليم، بناء المسار، التعلم المستمر' },
]
...
export const aboutSite = {
  ...
  distinct: [
    ...
    'يقدّم «مختارات د. أحمد»: قراءات وأدوات ومصادر أعود فيها إلى الأصل، وأوضح لماذا تستحق أن تبقى في المشهد.',
  ],
  audience: [
...
export const site = {
  ...
  // الوصف لا يحمل أرقاماً ثابتة؛ العدادات الحية تظهر داخل الواجهة من Firestore.
  description:
    'الموقع الرسمي للدكتور أحمد حسين الفيلكاوي، أستاذ تكنولوجيا التعليم والذكاء الاصطناعي، ويضم مؤلفاته وأبحاثه ومقالاته الفكرية في التعليم والتكنولوجيا والمجتمع.',
