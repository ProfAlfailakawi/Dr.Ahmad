...
const privacyArabic: LegalSection[] = [
  ...
  },
  {
    ...
    items: [
      'بيانات التواصل التي تقدمها طوعًا، مثل الاسم والبريد وموضوع الرسالة ونصها.',
      'بيانات تشغيل وأمان محدودة، مثل الصفحة التي تمت زيارتها، وقت الزيارة، مسار التنقل، حالة الطلب، ومعلومات تقنية إجمالية تساعد على اكتشاف الأعطال ومنع الإساءة.',
      'بيانات محفوظة محليًا في متصفحك، مثل تقدّم القراءة، موضع تشغيل الصوت، اختيارات العرض، وبعض التفضيلات المؤقتة. يمكنك حذفها من إعدادات المتصفح.',
  ...
  {
    title: '4. الخدمات التقنية والأطراف المعالجة',
    body: [
  ...
  },
  {
    ...
    body: [
      'قد يُرسل النص الذي يختاره المسؤول إلى Gemini لإنتاج مسودة أو حزمة نشر، أو إلى Azure Speech لإنشاء ملف صوتي. لا ينبغي إدخال أسرار أو كلمات مرور أو بيانات صحية أو مالية أو معلومات شخصية حساسة في أدوات التوليد. يجب مراجعة المخرجات بشريًا قبل اعتمادها أو نشرها.',
    ],
  },
  {
  ...
  },
  {
    ...
    body: [
      'نحتفظ بالبيانات فقط للمدة اللازمة للغرض الذي جُمعت من أجله، ولتشغيل الخدمة وتسوية المشكلات والوفاء بالمتطلبات القانونية. تُحذف أو تُعطّل رموز الوصول وبيانات الربط بعد فصل الحساب أو قبول طلب حذف موثّق، مع احتمال بقاء نسخ محدودة مؤقتًا في النسخ الاحتياطية أو السجلات الأمنية.',
      'نستخدم ضوابط وصول، وأسرارًا مُدارة، واتصالات مشفّرة، وقواعد أمان مناسبة. ومع ذلك لا توجد وسيلة نقل أو تخزين إلكتروني تضمن أمانًا مطلقًا.',
    ],
  },
  {
...
const termsArabic: LegalSection[] = [
  ...
  },
  {
    ...
    body: ['يوفر الموقع محتوى أكاديميًا وفكريًا، ووسائل تواصل وقراءة وصوت، وأداة خاصة لإدارة المقالات وتجهيز محتوى السوشيال وربط منصات النشر. لا تمثل المواد المنشورة استشارة قانونية أو طبية أو مالية أو بديلاً عن المختص.'],
  },
  {
    title: '3. الأهلية والحسابات',
    items: [
      'يجب أن تكون مخولًا قانونيًا لاستخدام الحسابات أو الصفحات التي تربطها بالخدمة.',
  ...
  },
  {
    ...
    body: ['تبقى حقوق المحتوى الأصلي لأصحابه. يحتفظ د. أحمد حسين الفيلكاوي بحقوق المواد الأصلية المنشورة باسمه ما لم يذكر خلاف ذلك. عند رفع مادة أو اختيارها للمعالجة، فإنك تمنح الخدمة إذنًا محدودًا لمعالجتها وتخزينها وإرسالها إلى المنصة المحددة بالقدر اللازم لتنفيذ طلبك.'],
  },
  {
...
const deletionArabic: LegalSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      'إلغاء الصلاحية يمنع استخدام رمز الوصول مستقبلًا. ولحذف السجلات الموجودة لدينا أيضًا، أرسل طلب الحذف بالطريقة التالية.',
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      'قد نطلب إثباتًا مناسبًا بأنك صاحب الحساب أو مخول بإدارته، من دون طلب كلمة المرور.',
      'بعد التحقق، نحذف أو نعطّل رموز الوصول، معرّفات الربط، بيانات الحساب المحفوظة، وسجلات النشر المرتبطة بقدر ما يمكن تحديدها.',
      'نعالج الطلب عادة خلال 30 يومًا. سنخبرك إذا احتجنا إلى معلومات إضافية أو مدة أطول لسبب قانوني أو تقني مشروع.',
  ...
  {
    title: 'ما الذي قد لا يُحذف تلقائيًا؟',
  ...
  {
    title: 'تأكيد الطلب',
    body: ['بعد إتمام المعالجة نرسل تأكيدًا إلى عنوان البريد المستخدم في الطلب، ما لم يمنع القانون أو الأمن ذلك. للاعتراض أو الاستفسار استخدم البريد نفسه.'],
  },
]
