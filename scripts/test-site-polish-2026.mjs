...
ok(encyclopediaPortal.includes('خريطة الموسوعة')
  && encyclopediaPortal.includes('بحث موحّد')
  && encyclopediaPortal.includes('الموسوعة المرئية')
  && encyclopediaPortal.includes('حقيبة تدريس الموسوعة')
  ...
  && encyclopediaPortal.includes('اقرأ الموضوع في الكتاب')
  ...
  && encyclopediaVideoIndex.includes('resolveConcept')
  && encyclopediaVideoClient.includes('/api/encyclopedia/videos')
  && encyclopediaVideoServer.includes('parseYouTubeContinuations')
  && nodeServer.includes('loadEncyclopediaVideoCatalog'), 'صفحة الموسوعة تفهرس القناة كاملة وتربط الفيديو بالباب والفصل والمفهوم والعرض والبحث بمشغل واحد خفيف')
