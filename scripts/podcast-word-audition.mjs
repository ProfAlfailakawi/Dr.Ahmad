...
/* كل كلمةٍ شكا منها الدكتور (٢٠ أغسطس ٢٠٢٦) مع جملتها الحاملة من المتن.
   ...
   لا كلمة مخترعة هنا. */
const WORDS = [
  /* الجولة السادسة (٢٠ أغسطس ٢٠٢٦ ليلاً) — كلمتان سمعهما إماراتيتين في
     كويتي-٧، و«ضعف ثقته» التي رفض بديلَيها في الجولة الخامسة («غير جيدين»)
     فتحتاج بدائل جديدة. حكم فرضية السكون كان ٢ من ٤، فالتشكيل يُجرَّب
     هنا أيضاً لكن لا يُفترض نجاحه. */
  { key: 'توقف خوفك', speaker: 'Fahad',
    carrier: 'بس هني الفرق بين إنك تفرح… وإنك بس {W} شوي.',
    options: ['توقف خوفك', 'تُوَقِّف خوفك', 'تهدّي خوفك'] },
  { key: 'نعلقه', speaker: 'Fahad',
    carrier: 'المعنى اللي إحنا {W} على النتيجة.',
    options: ['نعلقه', 'نُعَلِّقه', 'نربطه'] },
  { key: 'ضعف ثقته — بدائل جديدة', speaker: 'Noura',
    carrier: 'هالشي يجره بعدين ل{W} بنفسه.',
    options: ['اهتزاز ثقته', 'نقص ثقته', 'ضعف ثقته'] },
]
