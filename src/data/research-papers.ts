...
export const researchPapers: ResearchPaper[] = [
  {
    ...
    abstractAr: 'هدفت الدراسة إلى تقصي اتجاهات أعضاء هيئة التدريس نحو استخدام تكنولوجيا التعليم في كلية التربية الأساسية بالهيئة العامة للتعليم التطبيقي والتدريب في الكويت. اعتمد الباحثان المنهج الوصفي المسحي، وطوّرا استبانة بعد التحقق من صدقها وثباتها، ثم طبّقاها على عينة من أعضاء هيئة التدريس. وتقدم النتائج قراءة ميدانية لدرجة تقبّل تكنولوجيا التعليم والعوامل المرتبطة بتوظيفها في الممارسة الجامعية.',
    ...
    scholar: scholar('اتجاهات الهيئة التدريسية نحو استخدام تكنولوجيا التعليم في كلية التربية الأساسية في الهيئة العامة للتعليم التطبيقي والتدريب بدولة الكويت'),
    coAuthors: coAuthor,
  ...
  },
  {
    ...
    abstractAr: 'هدفت الدراسة إلى التعرف على فاعلية استخدام أعضاء هيئة التدريس للوسائط المتعددة في التعليم الجامعي من وجهة نظر طلبة كلية التربية الأساسية في الكويت. استخدم الباحثان المنهج الوصفي المسحي، وطبّقا استبانة من 35 فقرة على عينة عشوائية بلغت 395 طالباً وطالبة. أظهرت النتائج فاعلية الاستخدام بمتوسط كلي بلغ 3.18، ووجود فروق لصالح الإناث ولصالح طلبة السنتين الثالثة والرابعة، مع عدم وجود فروق دالة تعزى إلى التحصيل الدراسي.',
    ...
    scholar: scholar('فاعلية استخدام أعضاء هيئة التدريس للوسائط المتعددة في التعليم الجامعي من وجهة نظر الطلبة في كلية التربية الأساسية بدولة الكويت'),
    coAuthors: coAuthor,
  ...
  },
  {
    ...
    abstractAr: 'هدفت الدراسة إلى تقصي فاعلية الإبحار في المواقع الإلكترونية في تحسين مهارات التعلّم لدى طلبة كلية التربية الأساسية من وجهة نظرهم. استخدم الباحثان المنهج الوصفي المسحي وطبّقا أداة الدراسة على 383 طالباً وطالبة. أظهرت النتائج فاعلية الإبحار الإلكتروني بمتوسط كلي بلغ 3.11؛ وجاءت مهارة إدارة الاختبار أولاً ومعالجة المعلومات أخيراً، مع فروق مرتبطة بالجنس والسنة الدراسية والتحصيل في عدد من المجالات.',
    journal: 'مجلة التربية، جامعة الأزهر · المجلد 37، العدد 177، الجزء 2 · 2018 · ص 845–886',
    source: 'https://search.shamaa.org/fullrecord?ID=251995',
    ...
    scholar: scholar('فاعلية الإبحار في المواقع الإلكترونية على تحسين مهارات الطلبة نحو التعلم في كلية التربية الأساسية'),
    coAuthors: coAuthor,
  ...
  },
  {
    ...
    abstractAr: 'هدفت الدراسة إلى تقصي أهمية التعلّم الإلكتروني في اكتساب مهارات البحث العلمي لدى طلبة البكالوريوس والدراسات العليا في الكويت. شملت العينة 315 طالباً وطالبة من البكالوريوس و280 من الدراسات العليا. بيّنت النتائج أن امتلاك مهارات البحث العلمي جاء بدرجة متوسطة بمتوسط كلي 3.13، مع ضعف أوضح لدى طلبة البكالوريوس، وظهور فروق لصالح الإناث ولصالح طلبة الدراسات العليا.',
    ...
    scholar: scholar('أهمية التعلم الإلكتروني في اكتساب مهارات البحث العلمي من وجهة نظر طلبة البكالوريوس والدراسات العليا في دولة الكويت'),
    coAuthors: coAuthor,
  ...
  },
  {
    ...
    abstractAr: 'هدفت الدراسة إلى قياس درجة وعي أعضاء هيئة التدريس بمفهوم الواقع المعزّز في كلية التربية الأساسية بالهيئة العامة للتعليم التطبيقي والتدريب في الكويت. استخدم الباحثان المنهج الوصفي التحليلي واستبانة موزعة على أربعة مجالات، وطبقت على 100 عضو هيئة تدريس. أظهرت النتائج أن درجة الوعي جاءت متوسطة بمتوسط كلي 3.33، مع تفاوت بين معايير الجودة والهدف وطبيعة المفهوم وأنواعه.',
    ...
    scholar: scholar('Faculty Members Degree of Awareness of Augmented Reality Concept in the College of Basic Education Public Authority for Applied Education and Training in Kuwait'),
    coAuthors: coAuthor,
  ...
  },
  {
    ...
    abstractAr: 'بحثت الدراسة المعوقات التي تحدّ من توظيف تكنولوجيا التعليم ووسائلها لخدمة الطلبة ذوي الاحتياجات الخاصة من وجهة نظر أعضاء هيئة التدريس في الهيئة العامة للتعليم التطبيقي والتدريب. وقدمت تشخيصاً للعوائق البشرية والتقنية والتنظيمية التي تؤثر في الاستخدام الفعّال، بما يدعم تطوير بيئات تعليم أكثر إتاحة واستجابة لاحتياجات الطلبة.',
    ...
    scholar: scholar('Obstacles to the Employment of Education Technology and Means for Students with Special Needs from the Point of View of Faculty Members at the Public Authority for Applied Education and Training in Kuwait'),
  ...
  },
  {
    ...
    abstractAr: 'استقصت الدراسة مدى توافر كفايات التعلّم الإلكتروني لدى أعضاء هيئة التدريس في كلية التربية الأساسية بالكويت. وركزت على الجاهزية المعرفية والمهارية اللازمة لتخطيط التعلّم الإلكتروني وإدارته وتقويمه، بما يوضح جوانب القوة والاحتياجات التدريبية المرتبطة بالتحول الرقمي في التعليم الجامعي.',
    journal: 'International Journal of Applied Science and Technology · Vol. 11, No. 1 · 2021',
    source: 'https://ijast.thebrpi.org/journal/index/986',
    pdf: 'https://ijast.thebrpi.org/journals/Vol_11_No_1_March_2021/4.pdf',
    scholar: scholar('The Availability of E-Learning Qualifications Among Faculty Members at The Faculty of Basic Education in Kuwait'),
  ...
  },
  {
    ...
    abstractAr: 'هدفت الدراسة إلى الكشف عن واقع استخدام الحوسبة السحابية في التعليم الجامعي من وجهة نظر أعضاء هيئة التدريس في الكويت. وتناولت مستوى الاستخدام، والفوائد التعليمية والتنظيمية المتصورة، والعوائق التي تحد من تبنّي الخدمات السحابية، وصولاً إلى توصيات تعزز جاهزية مؤسسات التعليم العالي للاستفادة منها.',
    ...
    scholar: scholar('The Reality of Using Cloud Computing in University Education from The Point of View of Faculty Members in Kuwait'),
  ...
  },
  {
    ...
    abstractAr: 'هدفت الدراسة إلى تقصي أهمية استخدام أنظمة إدارة التعلّم الإلكتروني في بناء جامعة ذكية في الكويت من وجهة نظر أعضاء هيئة التدريس. اعتمدت المنهج الوصفي المسحي وطبقت أداة الدراسة على 246 عضواً. أظهرت النتائج مستوى أهمية متوسطاً بمتوسط كلي 3.33، وتراوحت المتوسطات بين 2.46 و4.37، مع فروق مرتبطة بالرتبة العلمية وسنوات الخبرة وعدم وجود فروق تعزى إلى الجنس.',
    ...
    scholar: scholar('How Important Is the Use of E-Learning Management Systems in Building a Smart University in Kuwait?'),
  ...
  },
  {
    ...
    abstractAr: 'هدفت الدراسة إلى استقصاء دور أنظمة إدارة التعلّم الإلكتروني في العملية التعليمية من وجهة نظر أعضاء هيئة التدريس بكلية التربية الأساسية في الكويت. استخدمت المنهج الوصفي المسحي، وشملت عينة عشوائية من 278 عضواً. أظهرت النتائج رضا مرتفعاً عن دور هذه الأنظمة، إذ تراوحت المتوسطات بين 3.82 و4.02 وبلغ المتوسط الكلي 3.90، بما يؤكد إسهامها الملحوظ في دعم عملية التعلّم.',
    ...
    scholar: scholar('Investigating The Role of E-Learning Management Systems in The Learning Process from The Point of View of The Faculty at The Faculty of Basic Education in Kuwait'),
  ...
  },
  {
    ...
    abstractAr: 'تناولت الدراسة أثر بيئة العمل ومبادئ علم التعلّم في أنظمة التعلّم الإلكتروني المستخدمة في التعليم من وجهة نظر أعضاء هيئة التدريس بكلية التربية الأساسية في الكويت. وتبحث العلاقة بين الظروف المؤسسية وتصميم التعلّم وكفاءة استخدام النظم الإلكترونية، بما يبرز أن نجاح التقنية لا ينفصل عن بيئة العمل والممارسات التعليمية المحيطة بها.',
    ...
    scholar: scholar('The Impact of The Working Environment and Learning Science in The Electronic Learning Systems Used in Education'),
  ...
  },
  {
    ...
    abstractAr: 'هدفت الدراسة إلى استقصاء تصورات طلبة كلية التربية الأساسية تجاه تطبيق Moodle في إدارة المقررات الإلكترونية وتعزيز التعلّم في الكويت. وتتناول مدى تقبل الطلبة للمنصة، ودورها في تنظيم المحتوى والأنشطة والتواصل والتقويم، والعوامل التي قد تدعم استخدامها الفعّال في البيئة الجامعية.',
    ...
    scholar: scholar('Perceptions of University Students at the College of Basic Education Toward Implementing Moodle in Managing E-Courses to Enhance Learning in Kuwait'),
    coAuthors: coAuthor,
  ...
  },
  {
    ...
    abstractAr: 'هدفت الدراسة إلى استكشاف تصورات طلبة كلية التربية الأساسية تجاه استخدام تقنية السبورة التفاعلية في التعليم في الكويت خلال العام الأكاديمي 2020/2021. استخدمت المنهج الوصفي المسحي، وطبقت استبانة من 32 فقرة على عينة عشوائية من 393 طالباً. أظهرت النتائج تصورات إيجابية مرتفعة بمتوسطات تراوحت بين 2.95 و4.17، مع عدم وجود فروق دالة تعزى إلى الجنس.',
    ...
    scholar: scholar("University Students' Perceptions at the College of Basic Education Regarding the Use of Interactive Blackboard Technology in Education in Kuwait for the Academic Year 2020/2021"),
    coAuthors: coAuthor,
  ...
  },
  {
    ...
    abstractAr: 'هدفت الدراسة إلى تقصي دور التصوير الإبداعي التكنولوجي في أطر التعليم المعاصر لتنمية معارف ومهارات وقدرات أساتذة كلية التربية الأساسية في الكويت. استخدمت المنهج الوصفي التحليلي المسحي على عينة عشوائية من 27 أستاذاً جامعياً. أظهرت النتائج إسهاماً ملحوظاً للتصوير الإبداعي في تحسين طرق التدريس وتفاعل الطلبة، وعدم وجود فروق دالة تعزى إلى الجنس.',
    ...
    scholar: scholar('The Role of Technological Creative Photography in Contemporary Education Frameworks in Developing the Knowledge Skills and Abilities of University Professors at the College of Basic Education in Kuwait'),
    coAuthors: coAuthor,
  ...
  },
  {
    ...
    abstractAr: 'تناولت الدراسة أهمية تبنّي أنظمة إدارة التعلّم في تعزيز جودة التدريس لدى أساتذة الجامعات في الكويت. وركزت على إسهام هذه الأنظمة في تنظيم المقررات، وإدارة التفاعل والتقويم، وتيسير الوصول إلى المحتوى، ودعم الممارسات التدريسية المرنة؛ بما يجعلها بنية مؤسسية للتطوير لا مجرد أداة تقنية.',
    ...
    scholar: scholar('The Importance of Adopting Learning Management Systems LMS to Enhance the Quality of Teaching Among University Professors in Kuwait'),
    coAuthors: coAuthor,
  ...
  },
  {
    ...
    abstractAr: 'بحثت الدراسة اتجاهات طلبة كلية التربية الأساسية نحو استخدام التصوير لتنمية مهارات التعلّم في الكويت. وتناولت التصوير بوصفه أداة معرفية وتطبيقية تساعد على الملاحظة والتوثيق وإنتاج المعنى، مع قياس مستوى تقبل الطلبة لهذا الاستخدام والعوامل التي تؤثر في توظيفه داخل الخبرات التعليمية.',
    journal: 'Educational Sciences Journal، Cairo University · 2024',
    source: 'https://ssj.journals.ekb.eg/article_402114.html',
    scholar: scholar('Trends of College of Basic Education students towards the use of photography to develop learning skills in Kuwait'),
    coAuthors: coAuthor,
  ...
  },
  {
    ...
    abstractAr: 'هدفت الدراسة إلى الكشف عن واقع استخدام طلبة الجامعة في الكويت لتطبيقات الأجهزة الذكية في التعلّم، وقياس أثر الجنس ومعدل الاستخدام. استخدمت المنهج الوصفي المسحي وطبقت أداة من 35 فقرة على عينة عشوائية من 385 طالباً في الفصل الثاني 2020/2021. جاءت محاور الاستخدام والأهمية بدرجة متوسطة، ولم تظهر فروق دالة تعزى إلى الجنس أو معدل الاستخدام.',
    ...
    scholar: scholar('The Reality of Using Smart Device Applications in Learning Applications by University Students at the College of Basic Education in Kuwait'),
    coAuthors: coAuthor,
  ...
  },
  {
    ...
    abstractAr: 'يركز البحث على اتجاهات طلبة كلية التربية الأساسية نحو استخدام تقنية السبورة التفاعلية في التعليم في الكويت خلال العام الأكاديمي 2021/2022، ويستقصي مستوى تقبلهم لهذه التقنية وقيمتها في دعم التفاعل والفهم والمشاركة. هذا الملخص التعريفي صيغ اعتماداً على العنوان المسجل، ويحتاج إلى مطابقته مع الملخص المنشور عند تزويد الموقع برابط الناشر أو النسخة الأصلية.',
    journal: 'Education and Linguistics Research · بيانات المجلد والصفحات تحتاج مراجعة يدوية',
    scholar: scholar('Trends of University Students at the College of Basic Education Toward the Use of Interactive Whiteboard Technology in Education in Kuwait 2021/2022'),
    url: '/research/trends-university-students-interactive-whiteboard-2021-2022',
    verification: 'needs-manual-review',
  },
  {
    slug: 'ms-teams-development-application-trends-as-a-quality-education-in-light-of-the-epidemiological-challenges-covid-19-in-kuwait-2',
    title: "Ms Teams’ Development Application Trends as a Quality Education in Light of The Epidemiological Challenges (Covid-19) In Kuwait",
    meta: 'MS Teams · Quality Education · COVID-19',
    abstractAr: 'تناولت الدراسة اتجاهات توظيف Microsoft Teams بوصفه تطبيقاً داعماً للتعليم النوعي في ضوء التحديات الوبائية في الكويت. وركزت على قدرة المنصة على استدامة التواصل وإدارة التعلّم والأنشطة والتقويم خلال جائحة كوفيد-19، وعلى ما يتطلبه الاستخدام الفعّال من ممارسات تعليمية وتنظيمية تتجاوز مجرد نقل المحاضرة إلى الإنترنت.',
    journal: 'Global Journal of Educational Studies · Vol. 8, No. 2 · 2022 · pp. 144–167',
    source: 'https://ideas.repec.org/a/mth/gjes88/v8y2022i2p144-167.html',
    pdf: 'https://www.macrothink.org/journal/index.php/gjes/article/view/20639/15991',
    scholar: scholar("Ms Teams’ Development Application Trends as a Quality Education in Light of The Epidemiological Challenges Covid-19 In Kuwait"),
    url: '/research/ms-teams-development-application-trends-as-a-quality-education-in-light-of-the-epidemiological-challenges-covid-19-in-kuwait-2',
    verification: 'verified',
  },
]
