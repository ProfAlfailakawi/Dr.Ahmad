...
const WORDS = [
  ...
  /* [محسوم ٢١ أغسطس ليلاً — الجولة العاشرة/الكلمات الأربع] أرقامه:
     ١=٣ يظيّع ثقته بروحه · ٢=٢ طَالِب · ٣=٢ منو ربح · ٤=٢ يِي.
     كلها مقفولة في المعجم؛ بقيت ثماني كلمات فحص المتن أدناه. */
