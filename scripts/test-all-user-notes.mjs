...
check('نبض المقال إشارة هامشية لا كرت مستقل ولا استعلام Firestore مكرر', resonance.includes('article-pulse-mark') && resonance.includes('createPortal') && !resonance.includes('getDb') && articleDetail.includes('<ArticlePulse quote={articlePulse.quote}'))
...
check('بوابة الموسوعة توحد الأبواب والفيديو والبحث وحقيبة التدريس', encyclopediaPortal.includes('خريطة الموسوعة') && encyclopediaPortal.includes('الموسوعة المرئية') && encyclopediaPortal.includes('بحث موحّد') && encyclopediaPortal.includes('حقيبة تدريس الموسوعة'))
