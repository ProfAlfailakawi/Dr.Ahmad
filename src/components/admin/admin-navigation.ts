    ...
    sections: [
      {
        ...
        items: [
          ...
          /* المونتير الآلي (سبتمبر ٢٠٢٦): مقالةٌ أو تغريدة ← فيديو مشاهد يفهم
             موضوعها — استعارة لكل معنى، إنفوجرافيك، موسيقى من مكتبة الموقع،
             وتصدير ملف. إضافةٌ مستقلة فوق استوديو التصاميم لا تعديلٌ له. */
          { tab: 'monteur', label: 'المونتير الآلي', note: 'حوّل أي مقالة أو تغريدة إلى فيديو مشاهد يفهم موضوعها' },
