...
export const papers = [
  { slug: 'ms-teams-development-application-trends-as-a-quality-education-in-light-of-the-epidemiological-challenges-covid-19-in-kuwait-2', title: 'اتجاهات تطبيق Ms Teams كتعليمٍ نوعي في ضوء تحديات جائحة كوفيد-19 في الكويت', meta: 'MS Teams · Quality Education', journal: 'Global Journal of Educational Studies · 8(2) 2022 · ص 144–167', source: 'https://ideas.repec.org/s/mth/gjes88.html', url: '/research/encyclopedia' },
  ...
  { slug: 'faculty-members-degree-of-awareness-of-augmented-reality-concept-in-the-college-of-basic-education-public-authority-for-applied-education-and-training-in-kuwait-2', title: 'درجة وعي أعضاء هيئة التدريس بمفهوم الواقع المعزّز في كلية التربية الأساسية', meta: 'Augmented Reality Awareness', url: '/research/faculty-members-degree-of-awareness-of-augmented-reality-concept-in-the-college-of-basic-education-public-authority-for-applied-education-and-training-in-kuwait-2' },
  { slug: 'faculty-attitudes-edtech', title: 'اتجاهات الهيئة التدريسية نحو استخدام تكنولوجيا التعليم في كلية التربية الأساسية', meta: 'Faculty Attitudes · Ed-Tech', url: '/research/faculty-attitudes-edtech' },
  { slug: 'multimedia-higher-education', title: 'فاعلية استخدام أعضاء هيئة التدريس للوسائط المتعددة في التعليم الجامعي', meta: 'Multimedia in Higher Education', url: '/research/multimedia-higher-education' },
  { slug: 'web-navigation-learning-skills', title: 'فاعلية الإبحار في المواقع الإلكترونية على تحسين مهارات الطلبة نحو التعلّم', meta: 'Web Navigation · Learning Skills', url: '/research/web-navigation-learning-skills' },
  { slug: 'elearning-research-skills', title: 'أهمية التعلّم الإلكتروني في اكتساب مهارات البحث العلمي لدى طلبة البكالوريوس والدراسات العليا', meta: 'E-Learning · Research Skills', url: '/research/elearning-research-skills' },
]
