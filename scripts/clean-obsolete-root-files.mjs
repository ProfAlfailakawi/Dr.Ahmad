...
const obsolete = [
  ...
  // بقية نُسخ الجذر الشبحيّة (نفس السبب: Google Studio تكتبها في الجذر، والحيّ
  // الوحيد هو src/ و scripts/ و whatsapp-agent/). كلّها أصغر من نظيرتها الحيّة
  // وأقدم؛ إبقاؤها يغري أداة المزامنة بتعديل الشبح بدل الشجرة الحقيقية.
  // ملاحظة: server.mjs في الجذر ليس شبحاً — هو خادم الإنتاج (npm start) فلا يُحذف.
  'AdminArchitecture.tsx',
  'ArticleReader.tsx',
  'AskLibrary.tsx',
  'Atlas.tsx',
  'BotMessagesPanel.tsx',
  'BroadcastStudio.tsx',
  'CV.tsx',
  'ContactForm.tsx',
  'ContentManager.tsx',
  ...
  'ThoughtPaths.tsx',
  'Upcoming.tsx',
  'WhatsAppAgentPanel.tsx',
  'persistent-audio.tsx',
  'ui.tsx',
  'auto-audio.mjs',
  'auto-site-content.mjs',
  'bot-messages.mjs',
  'bot-rules.mjs',
  'build-static.mjs',
  'content.ts',
  'data.ts',
  'events.ts',
  'guard-private-books.mjs',
  'idea-life.ts',
  'intelligence.ts',
  'podcast-dialogue.mjs',
  'private-books-memory.mjs',
  'purge-deleted-content.mjs',
  'seasons.ts',
  'self-test.mjs',
  'social-templates.ts',
  'views.ts',
