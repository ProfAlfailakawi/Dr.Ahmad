...
export const TAIL = Object.freeze({
  ...
  chaseMore: (years, count) => `فكرةٌ لاحقتْه ${years} سنة، ولها ${count === 1 ? 'نصٌّ آخر' : `${count} نصوصٍ أخرى`} — اكتب «زدني».`,
...
const TAIL_SHAPES = [
  ...
  /^فكرةٌ لاحقتْه \d+ سنة\.$/,
  /^فكرةٌ لاحقتْه \d+ سنة، ولها (?:نصٌّ آخر|\d+ نصوصٍ أخرى) — اكتب «زدني»\.$/,
...
const HEADER_SHAPES = [
  ...
  /^عاد د\. أحمد إلى هذه الفكرة (?:مرتين|\d+ مرات|\d+ مرة) (?:في \d{4}|بين \d{4} و\d{4}) — (?:وهذا نصّه حرفياً|وهذان طرفاها: الأقدم والأحدث):$/,
