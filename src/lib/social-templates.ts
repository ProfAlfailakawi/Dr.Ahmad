...
/* ⚠️ محرك «الطبعة الفاخرة» — لا يُستبدل بنسخة مبسّطة.
   استُعيد 2026-07-19 بعد أن قلّصته دفعةٌ موازية من 1060 سطراً إلى 572، ففقدت
...
export async function renderSocialPng(inputTemplate: SocialVisualTemplate) {
  ...
  /* جذر «الخطوط غير جيدة» (ملاحظة الدكتور 31 يوليو): الكانفس يطلب
     «El Messiri» بوزن 700 — لكن المتصفح **لا يُنزّل خطاً لمجرد ذكره في
