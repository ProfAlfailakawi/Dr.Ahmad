...
if (SELF_TEST) {
  ...
  const stranger = matchArticle('نَصٌّ غَرِيبٌ تَمَامًا عَنْ أَسْعَارِ النِّفْطِ وَالذَّهَبِ فِي الأَسْوَاقِ العَالَمِيَّةِ اليَوْمَ وَغَدًا وَبَعْدَ غَدٍ أَيْضًا.', bodies)
