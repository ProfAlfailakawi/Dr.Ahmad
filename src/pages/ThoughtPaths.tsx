...
const paths: ThoughtPath[] = [
  {
    ...
    intro: 'كيف تصبح التكنولوجيا أكثر تقدماً من دون أن يصبح الإنسان هامشاً في تجربتها؟',
  ...
  },
  {
    ...
    intro: 'رحلة بين فضول الطفل والشاشة: متى تكون التكنولوجيا أداة نمو، ومتى تقوده بدلاً من أن يقودها؟',
