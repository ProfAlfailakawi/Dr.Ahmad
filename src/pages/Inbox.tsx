...
export default function Inbox() {
  ...
  /* المخبوز شبكةُ أمانٍ لا محتوى.
     كان يُلحَق بالحيّ دائماً، فتظهر رسائلُ وأسئلةٌ مكتوبةٌ في الكود جنباً إلى
     جنبٍ مع المنشور من اللوحة — لا تراها اللوحة ولا تستطيع تعديلها ولا حذفها،
     والصفحة تبدو تلقائيةً وهي ليست كذلك. الآن لا يظهر إلا حين يخلو القسم:
     فإن تعطّل الاتصال لم تفرغ الصفحة، وإن امتلأ من اللوحة اختفى وحده. */
  ...
  const letters = (liveLetters.length ? liveLetters : seedLetters)
    .filter((item) => item.message)
  ...
  const questions = (liveAnswers.length ? liveAnswers : [...seedFaqs, ...rotate(faqs)])
