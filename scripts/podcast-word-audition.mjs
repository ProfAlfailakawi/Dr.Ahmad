...
/* كل كلمةٍ شكا منها الدكتور (٢٠ أغسطس ٢٠٢٦) مع جملتها الحاملة من المتن.
   ...
   لا كلمة مخترعة هنا. */
const WORDS = [
  /* الجولة السابعة (٢١ أغسطس ٢٠٢٦) — «منو غلبت» سمعها الدكتور خطأً من
     المتحدّثَين معاً («اثنينهم قالوها غلط»)، وهذا يرجّح أن العلة في النص
     لا في الصوت: «غلبت» صيغةُ مخاطبٍ/مؤنث، والسياق يطلب الغائب «غلب». */
  { key: 'منو غلبت', speaker: 'Noura',
    carrier: 'ومو: {W}؟ اسأله: أنت اليوم أنضج شوي من نفسك أمس؟',
    options: ['منو غلبت', 'منو غلب', 'منو الأول'] },
]
