 ...
 * منسوبةً إليه بعنوانها وتاريخها ورابطها. ومن 164 متناً × جُملٍ في كل متن
...
/* الجملة المعروضة: مكتملة، لا قصيرةً فتفقد المعنى ولا طويلةً فتُثقل البطاقة.
   والحدّان مقيسان على متون الدكتور لا مخمَّنان: أقصر جملةٍ دالّة عنده نحو 60
   حرفاً، وما تجاوز 220 يصير فقرةً لا اقتباساً. */
const MIN_LENGTH = 60
...
/* بأمر الدكتور (2026-07-23): الأصداء تتجدد مع كل تحديث صفحة — قرعةٌ لكل
