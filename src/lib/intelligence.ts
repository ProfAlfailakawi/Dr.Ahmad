...
export function styleFingerprint(articles: ArticleLike[]) {
  ...
  return {
    ...
    guidance: [
      ...
      'اجعل التكنولوجيا أو النظام وسيلة لفهم أثرها في الطالب والمعلم والإنسان.',
...
export function articleSystem(article: ArticleLike, articles: ArticleLike[], books: SimpleBook[], papers: SimplePaper[]) {
  ...
  return {
    ...
    /* سؤال مشتق من جملة المقال الحقيقية — لا قالب واحد يُلصق بكل المقالات */
    studentQuestion: quote
...
export function automaticSeries(articles: ArticleLike[]) {
  const seeds = [
    { title: 'الإنسان في قلب الآلة', terms: 'ذكاء اصطناعي تكنولوجيا رقمي انسان آلة' },
