 ...
 *
 * ═══ حدُّ هذا المختبر — اقرأه قبل بناء أيّ جولةٍ جديدة ═══
 * [٢٨ أغسطس ٢٠٢٦] العينة المعزولة **ليست** حكماً نهائياً، وتخطئ في الاتجاهين:
 *  · «شُغُل» اختارها الدكتور سماعاً في عينةٍ معزولة، ثم سقطت داخل الحلقة كاملة.
 *  · والقاف عكسها: سقطت الكلمات الإحدى والأربعون كلها (٤١ من ٤١ تحمل قافاً)
 *    في هذا المختبر، ثم حكم على الحلقات كاملةً: «القاف تقريباً ضبط».
 * والسبب أن جملة الفحص القصيرة تجرّد الحرف من السياق والإيقاع اللذين ينطقانه.
 * **فلا تُبنى جولةُ مختبرٍ معزولةٍ لحرفٍ بعينه — والقاف أولها**: تنتج رفضاً
 * كاذباً لكلماتٍ سليمةٍ في الإنتاج وتصرف الرصيد على تشخيصٍ مضلّل. حكم الحرف
 * يُؤخذ من الحلقة الكاملة وحدها. يبقى هذا المختبر نافعاً لما صُمّم له:
 * الكلمة الجديدة التي لم تُسمع قطّ، لا الحرف المستقرّ في متنٍ يُسمع كل يوم.
 */
