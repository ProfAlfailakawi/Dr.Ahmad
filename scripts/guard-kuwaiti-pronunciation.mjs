...
const CASES = [
  ...
  /* نطق الاسم المعتمد كتبه الدكتور بيده مشكّلاً (١٥ أغسطس): «الفِيلجَاوي» —
     الحروف ا ل ف ي ل ج ا و ي. لا ألف بعد اللام، لا كاف، لا چ. */
  ['الفيلكاوي قال', 'الفِيلجَاوي', 'الفيلچاوي'],
  ['قال الفيلكاوى', 'الفِيلجَاوي', 'الفيلاجاوي'],
