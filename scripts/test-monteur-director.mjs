...
/* قصٌّ بين علامتين ثابتتين بدل تعبيرٍ نمطي بتكرارٍ متداخل (CodeQL js/redos). */
const energyOpen = 'function storyEnergy(i,total,peak){'
const energyStart = source.indexOf(energyOpen)
const energyEnd = source.indexOf('}\nvar DIRECTION_CUTS', energyStart)
const energyBody = energyStart >= 0 && energyEnd > energyStart ? source.slice(energyStart + energyOpen.length, energyEnd) : null
