...
const CASES = [
  ...
  /* نطق الاسم المعتمد بلسانه حرفاً حرفاً (١٥ أغسطس، هجّاه: «ال · في · لا · جا · وي»):
     الفيلاجاوي — ألفٌ بعد اللام وجيمٌ بألف. لا كاف ولا چ ولا اختزال بكسرة. */
  ['الفيلكاوي قال', 'الفيلاجاوي', 'الفيلچاوي'],
  ['قال الفيلكاوى', 'الفيلاجاوي', 'الفيلِجاوي'],
  ...
  ['قيمته كلها معلقة بدرجته', 'معَلَّقة', null],
