...
ok(extras.includes("const dialogueLabel = 'بين صوتين'") && extras.includes('aria-label="فتح بين صوتين"')
  && extras.includes('نص «بين صوتين»') && !extras.includes("label: 'الحوار'"), 'الامتداد الصوتي داخل المقال يظهر باسم «بين صوتين» بلا Badge حوار مزعج')
...
ok(podcastManual.includes("musicClip('intro', 4.8, 0.08)") && podcastManual.includes("music/still-light.mp3"), 'المقدمة الموسيقية الأصلية لمسار البودكاست اليدوي محفوظة ولا تتأثر بواجهة المقال')
