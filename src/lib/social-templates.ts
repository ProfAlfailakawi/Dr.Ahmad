...
/* اسمٌ عربيّ أنيق لكل تخطيط بصري — تعرضه لوحة النشر تحت كل بطاقة. */
const compositionNames: Record<SocialVisualLayout, string> = {
  editorial: 'افتتاحية', quote: 'اقتباس', split: 'مزدوجة', dark: 'ليل', event: 'حدث',
  timeline: 'خط زمني', question: 'سؤال', signature: 'توقيع', orbit: 'مدار', signal: 'إشارة',
  window: 'نافذة', manifesto: 'بيان', circuit: 'دارة', notebook: 'دفتر', human: 'إنسان',
  research: 'بحث', horizon: 'أفق', dialogue: 'حوار', arch: 'قوس', matrix: 'مصفوفة',
  layers: 'طبقات', focus: 'تركيز', wave: 'موجة', balance: 'توازن',
}
export const compositionNameOf = (layout: SocialVisualLayout): string => compositionNames[layout] || layout
