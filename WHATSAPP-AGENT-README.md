...
- **ذاكرة لهجة محلية محافظة:** تحفظ الصياغة غير المفهومة مشفّرة، ولا تربطها بنية معروفة إلا بعد ثلاث قرائن عالية الثقة من مصدرين مستقلين على الأقل، أو عبر ثلاثة أيام مختلفة. لا تتعلم جوابًا ولا معلومة من المستخدم، وتظل كل الإجابات من فهرس الموقع.
...
بعد الإيقاظ فقط، إذا وصلت صياغة كويتية أو عربية لم يفهمها المحرك فإنه يصمت ويحفظها محليًا بصورة مشفّرة. إذا تكررت الصياغة ثم أعاد أصحابها طلبًا واضحًا من النوع نفسه ثلاث مرات مع قرائن مستقلة؛ فلا يستطيع شخص واحد تدريبها بثلاث نقرات متتالية، يتعلم المحرك **النية الموجودة أصلًا** مثل «أحدث المقالات» أو «شنو جديد الدكتور». لا يولّد ردًا جديدًا ولا يعتمد نص المستخدم كمعلومة. ويمكن مراجعة الصيغ أو تجاهلها من لوحة التحكم في قسم «ذاكرة اللهجة الحيّة».
