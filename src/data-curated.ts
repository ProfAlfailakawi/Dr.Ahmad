 ...
 *   · الأسماء أدناه تحافظ على ذاكرة الأركان التحريرية — بالعربية
 *
...
export const curatedBank: Curio[] = [
  ...
  { kind: 'اقتباس وتأمل',
    ...
    source: 'جون ديوي — «عقيدتي التربوية» (1897)',
  ...
  { kind: 'اقتباس وتأمل',
    ...
    source: 'باولو فريري — «تربية المقهورين» (1970)',
  ...
  { kind: 'اقتباس وتأمل',
    ...
    source: 'ابن خلدون — «المقدمة» (1377م)' },
  { kind: 'اقتباس وتأمل',
  ...
  { kind: 'الرف المنسي',
    ar: '«الديمقراطية والتعليم» — جون ديوي (1916)',
  ...
  { kind: 'الرف المنسي',
    ar: '«مجتمع بلا مدارس» — إيفان إيليتش (1971)',
  ...
  { kind: 'الرف المنسي',
    ar: '«تربية المقهورين» — باولو فريري (1970)',
    ...
    url: 'https://en.wikipedia.org/wiki/Pedagogy_of_the_Oppressed' },
  { kind: 'الرف المنسي',
    ar: 'فصول التعليم في «المقدمة» — ابن خلدون (1377م)',
    ...
    source: 'ابن خلدون' },
  { kind: 'الرف المنسي',
    ar: '«التسلية حتى الموت» — نيل بوستمان (1985)',
  ...
  /* أداة تستحق */
  { kind: 'أداة تستحق',
    ar: 'نوت بوك إل إم — حاور مصادرك البحثية',
  ...
  { kind: 'أداة تستحق',
    ar: 'زوتيرو — مكتبة الباحث المفتوحة',
    arNote: 'إدارة المراجع والاقتباس بضغطة — المعيار الأكاديمي المفتوح منذ 2006.',
  ...
  { kind: 'أداة تستحق',
    ar: 'كونكتد بيبرز — خريطة بصرية لأي بحث',
  ...
  { kind: 'أداة تستحق',
    ar: 'سيمانتيك سكولر — بحث علمي يفهم الأوراق',
    arNote: 'محرك أكاديمي بالذكاء الاصطناعي من معهد ألن — 200+ مليون ورقة.',
  ...
  { kind: 'أداة تستحق',
    ar: 'أكاديمية خان — صف مجاني لكل البشر',
  ...
  { kind: 'أداة تستحق',
    ar: 'المقررات المفتوحة لمعهد ماساتشوستس للتقنية — مقررات كاملة بلا رسوم',
    arNote: 'منذ 2001: أعرق تجربة «تعليم مفتوح» في العالم.',
  ...
  { kind: 'رؤية عميقة',
    ...
    arNote: 'مؤشرات التعليم في 50+ دولة: الإنفاق، المعلمون، النواتج.',
...
export const monthlyBooks: Curio[] = [
  { kind: 'كتاب الشهر',
    ...
    source: 'Carol Dweck — Stanford (2006)',
  ...
  { kind: 'كتاب الشهر',
    ...
    source: 'Nicholas Carr (2010) — نهائي بوليتزر',
