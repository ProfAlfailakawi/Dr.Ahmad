...
ok(readerResonance.includes('article-pulse-mark')
  && readerResonance.includes('if (!quote) return null')
  && !readerResonance.includes('getDb')
  && articleDetail.includes('paragraph.slice(startOffset, endOffset)')
  && articleDetail.includes('<ArticlePulse quote={articlePulse.quote}'), 'نبض المقال صار إشارة هامشية من مصدر الاقتباسات نفسه، بلا بطاقة أو استعلام مكرر')
ok(encyclopediaPortal.includes('خريطة الموسوعة')
  ...
  && encyclopediaPortal.includes('encyclopedia-door-4.pptx'), 'صفحة الموسوعة بوابة مستقلة تجمع القراءة والبحث والفيديو والعروض بلا شبكة بطاقات مزدحمة')
