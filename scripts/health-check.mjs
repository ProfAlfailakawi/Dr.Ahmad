...
const corePages = ['/', '/articles', '/publications', '/research', '/cv', '/contact', '/ask', '/thought', '/thought-paths', '/decade', '/en', '/en/cv', '/en/research', '/en/contact', '/podcast.xml', '/feed.xml', '/sitemap.xml', '/podcast-cover.png']
