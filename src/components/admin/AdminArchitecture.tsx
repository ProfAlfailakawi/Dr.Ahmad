            ...
            {openArea && (() => {
              ...
              return (
                <motion.div
                  ...
                  className="absolute right-[calc(100%+0.8rem)] top-0 z-[70] max-h-[calc(100vh-7rem)] w-[min(340px,calc(100vw-8rem))] overflow-y-auto rounded-[1.6rem] border border-hair bg-canvas p-3 shadow-[0_34px_90px_-34px_rgba(21,22,26,.58)]"
                >
