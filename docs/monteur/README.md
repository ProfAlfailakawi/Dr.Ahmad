...
## التحولات والبصمة الخاصة

- يحمل كل فصل أثراً مرئياً من رمزه نحو رمز الفصل التالي؛ تتحول الاستعارة إلى بذرة للمعنى اللاحق بدلاً من قطع مشاهد منفصلة.
- تستخرج كل مقالة بصمة تجمع شكلاً عاماً ولون توهج ونمط جسيمات، وتتغير البصمة عند طلب إخراج جديد.
- يبني منحنى توتر من معنى الجملة وموقعها؛ فالسؤال والخطر والدليل والحل لا تتحرك بالكثافة نفسها.
- يزرع مفاجأة محسوبة كل ثلاثة فصول: كسر الإطار، كلمة عملاقة، قطع ضوئي، أو انقلاب منظور. تتبدل المفاجآت بين نسخ الإخراج.
- ترث الخاتمة العنصر الدلالي الأخير ثم تحسمه بالشعار الكوفي، من دون صور شخصية.
