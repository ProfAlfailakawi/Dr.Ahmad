...
export const NATIVE_SPOKEN_VERSION = '2026-08-24-native-kuwaiti-v2'
...
const PILOT_TURN_OVERRIDES = new Map([
  ...
  [4, { text: 'بس كل اللي حس فيه كان راحة شوي… وبس. مثل واحد كان محشور بباب ضيق وبعدين طلع منه.' }],
  [5, { text: 'بس مو النجاح بروحه يستاهل الفرحة؟' }],
  [7, { text: 'أكيد يستاهل. بس هني الفرق…' }],
  ...
  [20, { text: 'بس مو كبرنا الموضوع وايد؟' }],
  [21, { text: 'الدرجة بالنهاية تبيّن مستواه… بس مو كل شي فيه.' }],
  [22, { text: 'والأهم بعد… هالتجربة شنو غيّرت فيهم؟ صاروا أحسن؟' }],
  [23, { speaker: 'female', text: 'أوضح مع نفسهم؟ أهدأ؟' }],
  [24, { text: 'ترى في نجاح يطلع شكله وايد حلو… بس صاحبه ما حس بشي.' }],
  [25, { text: 'ودورنا مو بس نلمّع شكل النجاح. نبي الطالب يحس إن تعبه له معنى… مو بس شكل حلو جدام الناس.' }],
])
...
const PILOT_FULL_OVERRIDES = new Map([
  ...
  [2, { text: 'مو فرحة من قلب، ولا ذاك الإحساس اللي يي لما تنجز شي يعني لك. بس كل اللي حس فيه كان راحة شوي… وبس. مثل واحد كان محشور بباب ضيق وبعدين طلع منه.' }],
  [3, { text: 'بس مو النجاح بروحه يستاهل الفرحة؟ إذا الواحد عدى شي كان خايف منه، طبيعي يرتاح.' }],
  [4, { text: 'أكيد يستاهل. بس هني الفرق: إنك تفرح، وإنك بس توقف خوفك شوي. وترى مو كل نجاح يفرّح صاحبه؛ مرات الواحد بس يرتاح لأنه عدى اللي كان خايف منه.' }],
  ...
  [27, { text: 'والأهم بعد… هالتجربة شنو غيرت فيهم؟ صاروا أحسن؟ أوضح مع نفسهم؟ أهدأ؟' }],
  [34, { text: 'ترى في نجاح يطلع شكله وايد حلو… بس صاحبه ما حس بشي.' }],
  [35, { text: 'ودورنا مو بس نلمّع شكل النجاح. نبي الطالب يحس إن تعبه له معنى… مو بس شكل حلو جدام الناس.' }],
])
