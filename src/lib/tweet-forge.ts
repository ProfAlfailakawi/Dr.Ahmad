 ...
 *
 * ١ ــ **لا يُنسب إليه ما لم يقله.** كل جملةٍ تخرج بين قوسين منسوبةً إلى متنٍ
 ...
 *
 * ٢ ــ **بلا شبكة وبلا مقابل.** لا نموذج لغويّ ولا مفتاح API. التنويع يأتي من
 *     أربع عشرة زاويةً بلاغيةً مستقلة × بذرةٍ محكومةٍ بالنص، فلا تتكرر
 *     التغريدة ولا تتشابه الزوايا.
 *
 * ٣ ــ **الانتشار مقيسٌ لا مُدَّعى.** كل تغريدةٍ تخرج بدرجةٍ وبأسبابها: ما
