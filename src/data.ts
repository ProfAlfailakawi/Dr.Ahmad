...
export const site = {
  ...
  description:
    'الموقع الرسمي للدكتور أحمد حسين الفيلكاوي، أستاذ تكنولوجيا التعليم والذكاء الاصطناعي، ويضم مؤلفاته وأبحاثه ومقالاته الفكرية في التعليم والتقنية والمجتمع.',
